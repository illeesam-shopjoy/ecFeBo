  ...
  setup(props) {
    ...
    const handleBtnAction = (cmd, param = {}) => {
      ...
      // 사용자 페이스 미리보기 (새창)
        ...
        return onPreview();
      // SEO 테스트 — SEO 메타태그 서버사이드 주입(/foui/prodDtl/{prodId}) 응답 확인용(테스트 기간 유지)
...
계속하시겠습니까?`);
    ...
    /* onSeoTest — SEO 메타태그 서버사이드 주입(FoSeoController, GET /foui/prodDtl/{prodId}) 이 실제로
    ...
    const onSeoTest = () => {
      ...
      window.open(window.seoUrl('/foui/prodDtl/' + cfCurProdId.value), '_blank', 'width=900,height=700,scrollbars=yes');
    };
