...
window.Prod01View = {
  ...
  setup(props) {
    ...
    const fnCallbackModal = (popCmd, param, result) => {
      console.log(' ■■ Prod01View : fnCallbackModal -> ', popCmd, param, result);
    ...
    */
    ...
    const handleSearchList = async (searchType = 'DEFAULT') => {
      ...
      try {
        ...
        console.error('[handleSearchList:getPromotions]', e);
      }
    };
    ...
    const cfMockImages = computed(() => {
      ...
      if (real.length) {
        ...
        // 옵션값 → 표시명 매핑 (image.prodOpt1Id 가 무엇이든 라벨 만들 수 있도록)
    ...
    const fnNormalizeReview = (r) => {
      ...
      // svReviewImages(PdReviewAttachDto 배열)에서 해당 리뷰 이미지 찾기
