(async function(){var ue,ve;await window.__SITE_CONFIG_READY__;const{createApp:Xe,ref:p,reactive:v,computed:E,watch:F,onMounted:Ze,onBeforeUnmount:Ke}=Vue,fe=Pinia.createPinia();window.foAuth.init(fe);const K=Xe({setup(){var Qe,Ye,We;const z=p(!1);window.foInitReady=!1,(async()=>{var t,o,a,s,n,d,i,l,u,y;const e=(t=window.useFoAuthStore)==null?void 0:t.call(window);if(e!=null&&e.svAccessToken)try{await((s=(a=(o=window.useFoAppInitStore)==null?void 0:o.call(window))==null?void 0:a.saFetchFoAppInitData)==null?void 0:s.call(a))}catch(c){((n=c==null?void 0:c.response)==null?void 0:n.status)===401?(console.warn("[foApp] token invalid (401), reset session"),(d=e.saClearSession)==null||d.call(e)):console.warn("[foApp] saFetchFoAppInitData error:",((i=c==null?void 0:c.response)==null?void 0:i.status)||c.message)}else(y=(u=(l=window.useFoAppInitStore)==null?void 0:l.call(window))==null?void 0:u.saRestoreFromStorage)==null||y.call(u);z.value=!0,window.foInitReady=!0})();const G=p(localStorage.getItem("modu-fo-sy-theme")||"light"),me=e=>{G.value=e,localStorage.setItem("modu-fo-sy-theme",e),document.documentElement.setAttribute("data-theme",e)};me(G.value);const et=()=>me(G.value==="light"?"dark":"light"),r=p("home"),te=p(!1),oe=p(""),tt={prodList:"\uC0C1\uD488 \uBAA9\uB85D",prodView:"\uC0C1\uD488 \uC0C1\uC138",cart:"\uC7A5\uBC14\uAD6C\uB2C8",order:"\uC8FC\uBB38 \xB7 \uACB0\uC81C",contact:"\uACE0\uAC1D\uC13C\uD130",faq:"FAQ",event:"\uC774\uBCA4\uD2B8",eventView:"\uC774\uBCA4\uD2B8 \uC0C1\uC138",blog:"\uBE14\uB85C\uADF8",blogView:"\uBE14\uB85C\uADF8 \uC0C1\uC138",blogEdit:"\uBE14\uB85C\uADF8 \uAE00\uC4F0\uAE30",like:"\uC704\uC2DC\uB9AC\uC2A4\uD2B8",location:"\uC704\uCE58\uC548\uB0B4",about:"\uD68C\uC0AC\uC18C\uAC1C",myOrder:"\uC8FC\uBB38\uB0B4\uC5ED",myClaim:"\uD074\uB808\uC784\uB0B4\uC5ED",myCoupon:"\uCFE0\uD3F0\uD568",myCache:"\uC801\uB9BD\uAE08 \xB7 \uCE90\uC2DC",myContact:"\uBB38\uC758\uB0B4\uC5ED",myChatt:"\uCC44\uD305\uC0C1\uB2F4",dispUi01:"\uC804\uC2DC UI 01",dispUi02:"\uC804\uC2DC UI 02",dispUi03:"\uC804\uC2DC UI 03",dispUi04:"\uC804\uC2DC UI 04",dispUi05:"\uC804\uC2DC UI 05",dispUi06:"\uC804\uC2DC UI 06",error401:"\uC811\uADFC \uC81C\uD55C",error404:"\uD398\uC774\uC9C0\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC74C",error500:"\uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4"};F(r,e=>{const t=tt[e];t?foUtil.fofSetPageMeta({title:t+" - ShopJoy"}):foUtil.fofResetPageMeta()});const he=window.foAppFunc.fmtXHeaders;window.addEventListener("api-response-success",e=>{if(!q.value)return;const t=e.detail||{};m(`${t.method} ${t.url} ${t.status}`,"info",1e4,t.detail||"")}),window.addEventListener("api-response-error",e=>{var n,d;const t=e.detail||{},o=t.status;let a="";t.method&&t.url&&(a=`${t.method} ${t.url} ${o}`,t.uiLabel&&(a+=` :: ${t.uiLabel}`));let s=a?`${a}
${t.message||""}`:t.message||"";if(o===0||o>=400)try{(d=(n=window.foNotiStore)==null?void 0:n.fnAddError)==null||d.call(n,t)}catch{}if(o!==401&&!(o>=500||o===0)){let i=t.errorDetails||"";const l=he(t.reqHeaders),u=he(t.resHeaders);if(l||u){let y="";const c=new Date,jt=c.getFullYear()+"-"+String(c.getMonth()+1).padStart(2,"0")+"-"+String(c.getDate()).padStart(2,"0")+" "+String(c.getHours()).padStart(2,"0")+":"+String(c.getMinutes()).padStart(2,"0")+":"+String(c.getSeconds()).padStart(2,"0");l&&(y+="\u2501\u2501 \uC694\uCCAD \uD5E4\uB354 \u2501\u2501  "+jt+`
`+l),u&&(y+=(y?`

`:"")+`\u2501\u2501 \uC751\uB2F5 \uD5E4\uB354 \u2501\u2501
`+u),i=i?y+`

`+i:y}m(s,"error",0,i);return}if(o===401){oe.value=s,r.value="error401";try{window.history.replaceState(null,"",window.location.pathname+"?page=error401")}catch{}}else if(o>=500||o===0){oe.value=s,r.value="error500";try{window.history.replaceState(null,"",window.location.pathname+"?page=error500")}catch{}}});const we=p(!0),S=v({mobileOpen:!1,showLogin:!1});let ae=!1;const ot=()=>{S.mobileOpen=!1},at=()=>{S.mobileOpen?S.mobileOpen=!1:(window.innerWidth<1024&&(we.value=!0),S.mobileOpen=!0)},L=p(null),g=v([]),f=p(null),it=window.foAppFunc.instantOrderToParams,ye=e=>{const t=e.get("prodId")||"";if(!t||!Array.isArray(b))return null;const o=b.find(i=>String(i.prodId)===t);if(!o)return null;const a=e.get("opt1Nm")||"",s=Array.isArray(o.opt1s)&&o.opt1s.find(i=>i.name===a)||null,n=e.get("opt2Id")||null,d=Math.max(1,Number(e.get("qty"))||1);return{prod:o,color:s,size:n,qty:d}},U=v({}),j=v({}),M={},B=window.FO_LAZY_CLASS_FILES||{},st=window.FO_REG_TO_GLOBAL||{},xe=window.FO_PAGE_TO_CLASS||{},nt=e=>e.split("-").map(t=>t.charAt(0).toUpperCase()+t.slice(1)).join(""),lt=e=>import(new URL(e,document.baseURI).href),H={},be=(e,t)=>{if(t.has(e))return Promise.resolve();t.add(e);const o=B[e];if(!o)return Promise.resolve();if(H[e])return H[e];const a=st[e]||e;return H[e]=(async()=>{var i;if(window[a]||await lt(o),!window[a])throw new Error(`[lazy] ${o} \uB97C \uB85C\uB4DC\uD588\uC9C0\uB9CC window.${a} \uAC00 \uC815\uC758\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uC555\uCD95 \uC2DC property mangling \uC774 \uCF1C\uC838\uC788\uB294\uC9C0 \uD655\uC778\uD558\uC138\uC694(\uBC18\uB4DC\uC2DC \uAEBC\uC57C \uD569\uB2C8\uB2E4).`);K.component(e,window[a]),j[e]=!0;const s=String(((i=window[a])==null?void 0:i.template)||""),d=[...new Set([...s.matchAll(/<([a-z][a-z0-9]*(?:-[a-z0-9]+)+)\b/g)].map(l=>l[1]))].map(nt).filter(l=>B[l]);await Promise.all(d.map(l=>be(l,t)))})().catch(s=>{throw delete H[e],delete j[e],s}),H[e]},ie=async e=>{if(!(!e||j[e])){if(!B[e]){j[e]=!0;return}await be(e,new Set)}},N=async e=>{if(U[e])return;const t=xe[e];if(!t){U[e]=!0;return}await ie(t),M[e]&&window[t]&&(M[e].value=window[t]),U[e]=!0},rt=e=>{const t=xe[e];return!t||!B[t]||!!U[e]},se=async(e,t={})=>{var o;if(t&&t.replace&&(ae=!0),t&&t.instantOrder!==void 0?L.value=t.instantOrder:e!=="order"&&(L.value=null),t&&t.cartIds!==void 0?g.splice(0,g.length,...Array.isArray(t.cartIds)?t.cartIds:[]):e!=="order"&&g.splice(0,g.length),t&&t.dtlId!==void 0?f.value=t.dtlId:t&&t.eventId!==void 0?f.value=t.eventId:f.value=null,S.mobileOpen&&(S.mobileOpen=!1),!!pe(e)){te.value=!0;try{await N(e)}catch(a){m("\uD654\uBA74\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: "+(a&&a.message||a),"error");return}finally{te.value=!1}r.value=e,window.scrollTo(0,0);try{(o=document.querySelector(".layout-main"))==null||o.scrollTo(0,0)}catch{}}};window.addEventListener("resize",()=>{window.innerWidth<1024&&(S.mobileOpen=!1)});const Se=15,x=v(JSON.parse(localStorage.getItem("modu-fo-sy-apiLog")||"[]")),R=p(localStorage.getItem("modu-fo-sy-apiLogOpen")==="true");F(R,e=>{try{localStorage.setItem("modu-fo-sy-apiLogOpen",e?"true":"false")}catch{}});const q=p(localStorage.getItem("modu-fo-sy-apiToastOpen")==="true");F(q,e=>{try{localStorage.setItem("modu-fo-sy-apiToastOpen",e?"true":"false")}catch{}});const $=p(!1),J=p(null),V=p(localStorage.getItem("modu-fo-sy-apiLogDock")==="true");F(V,e=>{try{localStorage.setItem("modu-fo-sy-apiLogDock",e?"true":"false")}catch{}});let dt=x.length?Math.max(...x.map(e=>e._seq||0))+1:1;const Le=e=>{const t=new Date,o=t.getFullYear()+"-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")+" "+String(t.getHours()).padStart(2,"0")+":"+String(t.getMinutes()).padStart(2,"0")+":"+String(t.getSeconds()).padStart(2,"0"),a={_seq:dt++,ts:o,...e};x.unshift(a),x.length>Se&&x.splice(Se);try{const s=x.map(({data:n,reqData:d,...i})=>i);localStorage.setItem("modu-fo-sy-apiLog",JSON.stringify(s))}catch{}},pt=()=>{x.splice(0,x.length),J.value=null;try{localStorage.removeItem("modu-fo-sy-apiLog")}catch{}},ct=window.foAppFunc.logStatusClass,gt=window.foAppFunc.logIsRecent,ft=window.foAppFunc.fmtSec,ut=window.foAppFunc.logMethodStyle;let A=null;const vt=e=>{A&&(clearTimeout(A),A=null),J.value=e},mt=()=>{A&&clearTimeout(A),A=setTimeout(()=>{J.value=null,A=null},200)},ht=()=>{A&&(clearTimeout(A),A=null)},wt=()=>{V.value=!V.value},yt=E(()=>R.value&&V.value?"280px":"0px"),xt=window.foAppFunc.fmtJson,bt=e=>{const t=x.findIndex(o=>o===e);return t>=0?x.length-t:"-"},St=window.foAppFunc.logBadgeStyle;window.addEventListener("api-response-success",e=>{Le(e.detail||{})}),window.addEventListener("api-response-error",e=>{Le({...e.detail||{},_isErr:!0})}),document.addEventListener("pointerdown",e=>{$.value&&(e.target.closest("[data-fo-settings]")||($.value=!1))},!0);const C=v([]);let Lt=0;const P=p(localStorage.getItem("modu-fo-sy-toast-isShowDetail")!=="false"),m=(e,t="success",o=0,a="",s=null)=>{let n=e,d="";if(e&&e.includes(`
`)){const c=e.split(`
`);d=c[0],n=c.slice(1).join(`
`)}const i=++Lt,l=o===0?t==="error"?0:t==="info"?3e3:4e3:o,u=!!a&&P.value,y={id:i,msg:e,msgTitle:n,msgDetail:d,type:t,detail:a,action:s,expanded:u,persistent:l===0,duration:l};C.push(y),l>0&&setTimeout(()=>Ae(i),l)},At=e=>{e.action&&typeof e.action.onClick=="function"&&e.action.onClick()},Ae=e=>{const t=C.findIndex(o=>o.id===e);t!==-1&&C.splice(t,1)},It=()=>{C.splice(0,C.length)},kt=()=>{P.value=!P.value,localStorage.setItem("modu-fo-sy-toast-isShowDetail",P.value),C.forEach(e=>{e.detail&&(e.expanded=P.value)})},Ct=e=>{e.expanded=!e.expanded},Ot={show:!1},Q=p(!1),Ie=p("\uC870\uD68C\uC911\uC785\uB2C8\uB2E4...");let ne=0,O=null,ke=0;const Et=300,Ft=50;window._showProgress=(e,t)=>{if(e&&t&&(Ie.value=t),ne=Math.max(0,ne+(e?1:-1)),ne>0)O&&(clearTimeout(O),O=null),Q.value||(ke=Date.now()),Q.value=!0;else{const o=Date.now()-ke,a=Math.max(0,Et-o)+Ft;O&&clearTimeout(O),O=setTimeout(()=>{Q.value=!1,O=null},a)}};const _=v({show:!1,title:"",msg:"",type:"info",resolve:null}),Ce=(e,t,o="info")=>new Promise(a=>Object.assign(_,{show:!0,title:e,msg:t,type:o,resolve:a})),Pt=()=>{var e;_.show=!1,(e=_.resolve)==null||e.call(_)},T=v({show:!1,title:"",msg:"",type:"warning",resolve:null}),Oe=(e,t,o="warning")=>new Promise(a=>Object.assign(T,{show:!0,title:e,msg:t,type:o,resolve:a})),_t=e=>{var t;T.show=!1,(t=T.resolve)==null||t.call(T,e)},Ee=e=>coUtil.cofAssignProdImage(e),Y=((Qe=window.SITE_CONFIG)==null?void 0:Qe.prods)||[];Y.forEach(Ee);const b=v([...Y]),I=p(Y.length>0?Y[0]:null),Fe=e=>{I.value=e,se("prodView")},Pe=(e,t)=>{const o=new URLSearchParams;o.set("page",e),t!=null&&(e==="prodView"?o.set("prodid",t):e==="eventView"?o.set("eventId",t):(e==="blogView"||e==="blogEdit")&&o.set("dtlId",t)),window.open(window.location.pathname+"?"+o.toString(),"_blank")},k=v(new Set);try{const e=localStorage.getItem("modu-fo-pd-like"),t=e?JSON.parse(e):null;Array.isArray(t)&&t.forEach(o=>k.add(o))}catch{}const Tt=()=>{try{localStorage.setItem("modu-fo-pd-like",JSON.stringify([...k]))}catch{}},_e=e=>{k.has(e)?k.delete(e):k.add(e),Tt()},Te=e=>k.has(e),Dt=E(()=>k.size),h=v([]),De=4;try{const e=localStorage.getItem("modu-fo-pd-compare"),t=e?JSON.parse(e):null;Array.isArray(t)&&t.forEach(o=>h.push(o))}catch{}const le=()=>{try{localStorage.setItem("modu-fo-pd-compare",JSON.stringify(h))}catch{}},ze=e=>h.some(t=>t.prodId===e),Ue=e=>{if(!e||!e.prodId)return!1;const t=h.findIndex(o=>o.prodId===e.prodId);return t>=0?(h.splice(t,1),le(),!0):h.length>=De?(m(`\uC0C1\uD488 \uBE44\uAD50\uB294 \uCD5C\uB300 ${De}\uAC1C\uAE4C\uC9C0 \uAC00\uB2A5\uD569\uB2C8\uB2E4.`,"error"),!1):(h.push(e),le(),!0)},Me=()=>{h.splice(0,h.length),le()},zt=E(()=>h.length),w=v([]),He=()=>coUtil.cofGenId(),Ut=()=>{try{const e=localStorage.getItem("modu-fo-od-cart");if(e){const t=JSON.parse(e);Array.isArray(t)&&t.forEach(o=>{const a=b.find(n=>n.prodId===o.prodId);if(!a)return;let s=o.color||{name:"\uAE30\uBCF8"};o.color&&Array.isArray(a.opt1s)&&a.opt1s.length&&(s=a.opt1s.find(n=>n.name===o.color.name)||o.color),w.push({cartId:o.cartId||He(),prod:a,color:s,size:o.size||"FREE",qty:o.qty||1})})}}catch{}try{const e=String(window.location.search||"").replace(/^\?/,"");if(e.includes("page=")){const t=new URLSearchParams(e).get("prodid")||"";if(t){const o=b.find(a=>String(a.prodId)===t);o&&(I.value=o)}}}catch{}!I.value&&b.length>0&&(I.value=b[0])},Mt=async()=>{var e,t;try{const a=((t=(e=(await foApiSvc.pdProd.getPage({pageNo:1,pageSize:200},"\uC0C1\uD488","\uBAA9\uB85D\uC870\uD68C")).data)==null?void 0:e.data)==null?void 0:t.pageList)||[];a.forEach(Ee),b.splice(0,b.length,...a)}catch{}Ut()};Ze(()=>{Mt()});const W=()=>{try{localStorage.setItem("modu-fo-od-cart",JSON.stringify(w.map(e=>({cartId:e.cartId,prodId:e.prod.prodId,color:e.color,size:e.size,qty:e.qty}))))}catch{}},Ht=E(()=>w.reduce((e,t)=>e+t.qty,0)),Ne=(e,t,o,a=1)=>{const s=t||{name:"\uAE30\uBCF8"},n=o||"FREE",d=w.find(i=>i.prod.prodId===e.prodId&&i.color.name===s.name&&i.size===n);d?d.qty+=a:w.push({cartId:He(),prod:e,color:s,size:n,qty:a}),W(),m(`\uC7A5\uBC14\uAD6C\uB2C8\uC5D0 \uB2F4\uC558\uC2B5\uB2C8\uB2E4! (${s.name} / ${n})`,"success")},Re=e=>{w.splice(e,1),W()},qe=(e,t)=>{const o=w[e];if(!o)return;const a=o.qty+t;a<=0?w.splice(e,1):o.qty=a,W()},Ve=()=>{w.splice(0,w.length),W()},re=window.foAuth.state,Nt=()=>{ie("Login").then(()=>{S.showLogin=!0}).catch(e=>m("\uB85C\uADF8\uC778 \uD654\uBA74\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: "+(e&&e.message||e),"error"))},de=["myOrder","myClaim","myCoupon","myCache","myContact","myChatt"],pe=e=>{var t;return!de.includes(e)||((t=window.foAuth)!=null&&t.isLoggedIn?window.foAuth.isLoggedIn():localStorage.getItem("modu-fo-auth-accessToken"))?!0:(m("\uB85C\uADF8\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error"),S.showLogin=!0,!1)},Rt=()=>{window.foAuth.logout(),m("\uB85C\uADF8\uC544\uC6C3\uB418\uC5C8\uC2B5\uB2C8\uB2E4.","info"),de.includes(r.value)&&(r.value="home")};F(()=>{var e;return((e=re.user)==null?void 0:e.authId)||""},e=>{!e&&de.includes(r.value)&&r.value!=="home"&&(r.value="home")});let Ge=!0;const X=["home","prodList","prodView","cart","order","contact","faq","event","eventView","blog","blogView","blogEdit","like","location","about","myOrder","myClaim","myCoupon","myCache","myContact","myChatt","dispUi01","dispUi02","dispUi03","dispUi04","dispUi05","dispUi06","sample01","sample02","sample03","sample04","sample05","sample06","sample07","sample08","sample09","sample10","sample11","sample12","sample13","sample14","sample21","sample22","sample23","xsStore","xsLocalStorage","error401","error404","error500"];let ce=Promise.resolve();try{const e=String(window.location.search||"").replace(/^\?/,""),t=e.includes("page="),o=t?new URLSearchParams(e):null;let a=null;if(t?(a=o.get("page"),a&&X.includes(a)&&pe(a)?ce=N(a).then(()=>{r.value=a}):a&&!X.includes(a)&&(r.value="notFound")):ce=N(r.value),a==="order"&&t){L.value=ye(o);const s=o.get("cartIds");s&&g.splice(0,g.length,...s.split(",").filter(Boolean))}if(t){const s=o.get("eventId"),n=o.get("dtlId");s?f.value=Number(s)||s:n&&(f.value=Number(n)||n)}}catch{}Ge=!1;let Z=!1;const je=()=>{if(!Z){Z=!0;try{const e=String(window.location.search||"").replace(/^\?/,""),t=new URLSearchParams(e),o=t.get("page");if(o&&X.includes(o)&&r.value!==o&&pe(o)?N(o).then(()=>{r.value=o}).catch(i=>{m("\uD654\uBA74\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: "+(i&&i.message||i),"error")}):o&&!X.includes(o)&&r.value!=="notFound"&&(r.value="notFound"),o==="order"){L.value=ye(t);const i=t.get("cartIds"),l=i?i.split(",").filter(Boolean):[];l.length===g.length&&l.every((y,c)=>y===g[c])||g.splice(0,g.length,...l)}else o&&o!=="order"&&(L.value!==null&&(L.value=null),g.length&&g.splice(0,g.length));const a=t.get("prodid")||"";if(a){const i=b.find(l=>String(l.prodId)===a);i&&I.value!==i&&(I.value=i)}const s=t.get("eventId"),n=t.get("dtlId"),d=s?Number(s)||s:n?Number(n)||n:f.value;d!==f.value&&(f.value=d)}catch{}setTimeout(()=>{Z=!1},0)}};window.addEventListener("popstate",je),F(r,e=>{var n,d;if(Ge||Z)return;const t=new URLSearchParams;if(t.set("page",r.value),e==="prodView"&&t.set("prodid",(d=(n=I.value)==null?void 0:n.prodId)!=null?d:""),e==="order"&&L.value){const i=it(L.value);Object.entries(i).forEach(([l,u])=>t.set(l,u))}e==="order"&&g.length&&t.set("cartIds",g.join(",")),e==="eventView"&&f.value!=null&&t.set("eventId",f.value),(e==="blogView"||e==="blogEdit")&&f.value!=null&&t.set("dtlId",f.value);const o=t.toString(),a=window.location.pathname+"?"+o;if(String(window.location.search||"").replace(/^\?/,"")!==o)if(ae){ae=!1;try{history.replaceState(null,"",a)}catch{}}else try{history.pushState(null,"",a)}catch{}});try{const e=String(window.location.search||"").replace(/^\?/,"");if(!e||!e.includes("page=")){const t=new URLSearchParams;t.set("page",r.value),r.value==="prodView"&&t.set("prodid",String((We=(Ye=I.value)==null?void 0:Ye.prodId)!=null?We:"")),history.replaceState(null,"",window.location.pathname+"?"+t.toString())}}catch{}Ke(()=>{window.removeEventListener("popstate",je)});const ge=window.FO_SITE_NO,Be=p(window["Home"+ge]||null),$e=p(window["Prod"+ge+"List"]||null),Je=p(window["Prod"+ge+"View"]||null);M.home=Be,M.prodList=$e,M.prodView=Je;const D=document.getElementById("_boot_loading")||document.getElementById("vue-app-loading"),qt=()=>{D&&(D.classList.add("done"),D.classList.add("vue-app-loading--done"),setTimeout(()=>{D.parentNode&&D.parentNode.removeChild(D)},350))};ce.catch(e=>{m("\uD654\uBA74\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: "+(e&&e.message||e),"error")}).finally(qt);const Vt=new Set(["home","prodList","prodView","cart","order","myOrder","myClaim","myCoupon","myCache","myContact","myChatt","event","eventView","blog","blogView","blogEdit"]),Gt=E(()=>!Vt.has(r.value));return window.foApp={get cart(){return w},get instantOrder(){return L.value},get cartIds(){return g},get config(){return window.SITE_CONFIG},get prods(){return b},get selectedProd(){return I.value},get auth(){return re},addToCart:Ne,removeFromCart:Re,updateCartQty:qe,clearCart:Ve,navigate:se,showToast:m,showAlert:Ce,showConfirm:Oe,toggleLike:_e,isLiked:Te,selectProd:Fe,openNewWindow:Pe,get compareList(){return h},toggleCompare:Ue,isCompared:ze,clearCompare:Me},{theme:G,toggleTheme:et,page:r,navLoading:te,sidebarOpen:we,navigate:se,closeMobileMenu:ot,toggleMobileMenu:at,toasts:C,showToast:m,removeToast:Ae,removeAllToasts:It,toggleToastDetail:Ct,toggleAllToastDetail:kt,toastShowDetail:P,toast:Ot,onToastAction:At,isApiLoading:Q,apiProgressLabel:Ie,alertState:_,showAlert:Ce,closeAlert:Pt,confirmState:T,showConfirm:Oe,closeConfirm:_t,prods:b,selectedProd:I,selectProd:Fe,openNewWindow:Pe,cart:w,cfCartCount:Ht,addToCart:Ne,removeFromCart:Re,updateCartQty:qe,clearCart:Ve,likes:k,toggleLike:_e,isLiked:Te,cfLikeCount:Dt,compareList:h,toggleCompare:Ue,isCompared:ze,clearCompare:Me,cfCompareCount:zt,instantOrder:L,cartIds:g,viewEditId:f,config:window.SITE_CONFIG,auth:re,uiState:S,onShowLogin:Nt,onLogout:Rt,foInitReady:z,loadedPages:U,cfIsPageLoaded:rt,fnEnsurePageLoaded:N,fnEnsureClassLoaded:ie,foHomeComp:Be,foProdListComp:$e,foProdViewComp:Je,foApiLogs:x,showApiLog:R,showSettings:$,apiLogHoverDetail:J,clearFoApiLogs:pt,foApiLogStatusClass:ct,foApiLogMethodStyle:ut,onFoApiLogEnter:vt,onFoApiLogLeave:mt,onFoApiLogDetailEnter:ht,formatJsonData:xt,fnFoApiLogIndex:bt,fnFoApiLogBadgeStyle:St,fnFoApiLogRecent:gt,fnFmtSec:ft,apiLogDock:V,onFoApiLogToggleDock:wt,cfApiLogDockPad:yt,apiToastEnabled:q,onToggleApiToast:()=>{q.value=!q.value},cfShowSidebar:Gt,onToggleApiLog:()=>{R.value=!R.value,$.value=!1},notFoundPageId:E(()=>{try{return new URLSearchParams(String(window.location.search||"").replace(/^\?/,"")).get("page")||""}catch{return""}}),errorMessage:oe,safe:window.safeUtil}},template:`
