window.Prod03View={name:"Prod03View",props:{navigate:{type:Function,required:!0}},setup(S){const{ref:x,reactive:g,computed:c,onMounted:ge,onBeforeUnmount:V,watch:C}=Vue,j=window.foApp.selectedProd,X=window.foApp.addToCart,ve=(e,t={})=>{if(e==="page-goHome")return S.navigate("home");if(e==="page-goProdList")return S.navigate("prodList");if(e==="page-goContact")return S.navigate("contact");if(e==="cart-add")return De();if(e==="order-buyNow")return Ne();if(e==="cart-addFromDrawer")return Ue();if(e==="quickBuy-openBuy")return We();if(e==="quickBuy-openCart")return He();if(e==="quickBuy-close"){o.quickBuyOpen=!1;return}else{if(e==="prod-toggleLike")return Z(t);if(e==="qty-inc"){o.qty++;return}else if(e==="qty-dec"){o.qty>1&&o.qty--;return}else if(e==="sizeGuideModal-open"){o.showSizeGuide=!0;return}else{if(e==="sizeGuideModal-close")return J("size-guide",{},null);if(e==="zoomModal-open"){o.zoomOpen=!0;return}else if(e==="zoomModal-close"){o.zoomOpen=!1;return}else if(e==="gallery-prev"){o.selectedImg=(o.selectedImg-1+B.value.length)%B.value.length;return}else if(e==="gallery-next"){o.selectedImg=(o.selectedImg+1)%B.value.length;return}else if(e==="photoModal-open"){o.photoPopupOpen=!0;return}else if(e==="photoModal-close"){o.photoPopupOpen=!1;return}else{if(e==="photoGrid-prev")return Je();if(e==="photoGrid-next")return Ze();if(e==="photoDetail-close")return _e();if(e==="photoDetail-prev")return Ke();if(e==="photoDetail-next")return $e();console.warn("[handleBtnAction] unknown cmd:",e)}}}},ue=(e,t={})=>{if(e==="options-colorSelect")return Te(t);if(e==="options-sizeSelect")return Oe(t);if(e==="tab-go")return Le(t);if(e==="gallery-rowSelect"){o.selectedImg=t;return}else if(e==="reviews-filterSelect"){o.reviewFilter=t;return}else if(e==="photoGrid-rowGo"){o.photoGridPage=t;return}else{if(e==="reviews-photoGridRowSelect")return Ye(t);if(e==="reviews-photoListRowSelect")return Qe(t);console.warn("[handleSelectAction] unknown cmd:",e)}},J=(e,t,i)=>{if(e==="size-guide"){if(i==null){o.showSizeGuide=!1;return}return}else console.warn("[fnCallbackModal] unknown popCmd:",e)},Z=e=>window.foApp.toggleLike(e),xe=e=>{var t,i,r;return(r=(i=(t=window.foApp).isLiked)==null?void 0:i.call(t,e))!=null?r:!1},o=g({loading:!1,error:null,selectedImg:0,selectedColor:null,selectedSize:null,qty:1,colorError:"",sizeError:"",activeTab:"detail",reviewFilter:"\uCD5C\uC2E0\uC21C",selectedReview:null,photoGridPage:1,tabFixed:!1,tabFixedTop:0,tabFixedLeft:0,tabFixedW:0,tabPlaceholderH:0,drawerMode:"buy",photoFromGrid:!1,showSizeGuide:!1,photoPopupOpen:!1,zoomOpen:!1,showBottomBar:!1,quickBuyOpen:!1,prodApiLoaded:!1});C(()=>o.showBottomBar,e=>{document.documentElement.style.setProperty("--fab-lift",e?"72px":"0px")}),V(()=>{document.documentElement.style.setProperty("--fab-lift","0px")});const be=g({}),p=g({}),L=e=>{Object.keys(p).forEach(t=>delete p[t]),e&&Object.assign(p,e)},me=(e,t,i,r)=>coUtil.cofMergeProdOpts(e,t,i,r);j&&L(j);const q=g([]),M=g([]),z=g([]),v=g({}),m=g([]),E=g([]),R=g({}),he=()=>coUtil.cofProdIdFromUrl(),k=e=>{var t,i,r;return(r=(i=(t=e==null?void 0:e.data)==null?void 0:t.data)!=null?i:e==null?void 0:e.data)!=null?r:null},F=e=>{const t=k(e);return Array.isArray(t)?t:(t==null?void 0:t.pageList)||(t==null?void 0:t.list)||[]},ye=async(e="DEFAULT")=>{var r,a;const t=he()||p.prodId;if(!t)return;try{const n=await foApiSvc.pdProd.getById(t,"\uC0C1\uD488\uC0C1\uC138","\uC0C1\uC138\uC870\uD68C"),s=k(n)||{},d=s.prod||s;if(d&&d.prodId){const f=me(d,{groups:s.prodOptTypes||[],items:s.prodOpts||[]},s.prodSkus||[],s.prodImgs||[]);L(f),foUtil.fofSetPageMeta({title:f.prodNm?f.prodNm+" | ShopJoy":void 0,description:f.advrtStmt||(f.prodNm?f.prodNm+" - ShopJoy\uC5D0\uC11C \uB9CC\uB098\uBCF4\uC138\uC694.":void 0)})}o.prodApiLoaded=!0}catch(n){console.error("[handleSearchList:getById]",n),o.prodApiLoaded=!0}const i=await Promise.allSettled([foApiSvc.pdProd.getContents(t,"\uC0C1\uD488\uC0C1\uC138","\uC0C1\uC138\uC124\uBA85\uC870\uD68C"),foApiSvc.pdProd.getRels(t,"\uC0C1\uD488\uC0C1\uC138","\uC5F0\uAD00\uC0C1\uD488\uC870\uD68C"),foApiSvc.pdProd.getReviews(t,{pageNo:1,pageSize:20},"\uC0C1\uD488\uC0C1\uC138","\uB9AC\uBDF0\uC870\uD68C"),foApiSvc.pdProd.getReviewImages(t,"\uC0C1\uD488\uC0C1\uC138","\uB9AC\uBDF0\uC774\uBBF8\uC9C0\uC870\uD68C"),foApiSvc.pdProd.getQna(t,{pageNo:1,pageSize:20},"\uC0C1\uD488\uC0C1\uC138","Q&A\uC870\uD68C")]);if(i[0].status==="fulfilled"&&q.splice(0,q.length,...F(i[0].value)),i[1].status==="fulfilled"&&M.splice(0,M.length,...F(i[1].value)),i[2].status==="fulfilled"){const n=k(i[2].value)||{},s=((r=n.reviewPage)==null?void 0:r.pageList)||[];z.splice(0,z.length,...s),Object.keys(v).forEach(f=>delete v[f]),Object.assign(v,n.summary||{});const d=n.attachImages||[];m.splice(0,m.length,...d)}if(i[3].status==="fulfilled"){const n=F(i[3].value);m.splice(0,m.length,...n)}if(i[4].status==="fulfilled"){const n=k(i[4].value)||{};E.splice(0,E.length,...((a=n.qnaPage)==null?void 0:a.pageList)||n.pageList||(Array.isArray(n)?n:[]))}try{const n=await foApiSvc.pdProd.getPromotions(t,"\uC0C1\uD488\uC0C1\uC138","\uD504\uB85C\uBAA8\uC158\uC870\uD68C");Object.keys(R).forEach(s=>delete R[s]),Object.assign(R,k(n)||{})}catch(n){console.error("[handleSearchList:getPromotions]",n)}},we=[{id:"detail",label:"\uC0C1\uC138\uC815\uBCF4"},{id:"size",label:"\uC0AC\uC774\uC988"},{id:"review",label:"\uC0C1\uD488\uD3C9"},{id:"qna",label:"Q&A"},{id:"style",label:"\uC2A4\uD0C0\uC77C"}],G=x(null),ee=x(null),T=x(null),O=x(null),D=x(null),N=x(null),U=x(null),W=12,ke=[["XS","36","82","60"],["S","38","86","62"],["M","40","90","64"],["L","42","96","66"],["XL","44","102","68"],["XXL","46","108","70"]],te={};te.sizeGuideGrid=[{key:"s0",label:"\uC0AC\uC774\uC988",align:"center",fmt:(e,t)=>t[0]},{key:"s1",label:"\uC5B4\uAE68 (cm)",align:"center",fmt:(e,t)=>t[1]},{key:"s2",label:"\uAC00\uC2B4 (cm)",align:"center",fmt:(e,t)=>t[2]},{key:"s3",label:"\uCD1D\uC7A5 (cm)",align:"center",fmt:(e,t)=>t[3]}];const Se=[{key:"s0",label:"\uC0AC\uC774\uC988",align:"center",fmt:(e,t)=>t[0]},{key:"s1",label:"\uC5B4\uAE68",align:"center",fmt:(e,t)=>t[1]},{key:"s2",label:"\uAC00\uC2B4",align:"center",fmt:(e,t)=>t[2]},{key:"s3",label:"\uCD1D\uC7A5",align:"center",fmt:(e,t)=>t[3]}],ze=[{emoji:"\u{1F456}",label:"\uCE90\uC8FC\uC5BC \uB8E9",desc:"\uB370\uB2D8 \uD32C\uCE20 + \uC2A4\uB2C8\uCEE4\uC988"},{emoji:"\u{1F457}",label:"\uD398\uBBF8\uB2CC \uB8E9",desc:"\uD50C\uB85C\uB7F4 \uC2A4\uCEE4\uD2B8\uC640 \uB9E4\uCE58"},{emoji:"\u{1F9E5}",label:"\uB808\uC774\uC5B4\uB4DC \uB8E9",desc:"\uC624\uBC84\uD54F \uC790\uCF13\uACFC \uD568\uAED8"},{emoji:"\u{1F45F}",label:"\uC2A4\uD3EC\uD2F0 \uB8E9",desc:"\uD2B8\uB799 \uD32C\uCE20 + \uC2A4\uB2C8\uCEE4\uC988"}],oe="assets/cdn/prod/img/shop/product",Re=(e,t)=>{const i=e.prodId||1;if((i<=12?"fashion":"prod")==="fashion"){const n=((i-1)*3+t*3)%12+1;return[1,2,3].map(s=>{const d=(n-1+s-1)%12+1;return{src:`${oe}/fashion/fashion-${d}.webp`,label:"\uC774\uBBF8\uC9C0 "+s}})}const a=((i-1)*3+t*2)%23+1;return[0,1,2].map(n=>{const s=(a-1+n)%23+1;return{src:`${oe}/prod_${s}.png`,label:"\uC774\uBBF8\uC9C0 "+(n+1)}})},B=c(()=>{const e=p;if(!e)return[];const t=Array.isArray(e.images)?e.images:[];if(t.length){const a=o.selectedColor||null,n=new Set;a&&(a.optId&&n.add(String(a.optId)),a.val&&n.add(String(a.val)),a.name&&n.add(String(a.name)));const s=new Map;(e.opt1s||[]).forEach(l=>{l.optId&&s.set(String(l.optId),l),l.val&&s.set(String(l.val),l),l.name&&s.set(String(l.name),l)});const d=new Map;(e.opt2sAll||[]).forEach(l=>{l.optId&&d.set(String(l.optId),l),l.val&&d.set(String(l.val),l),l.name&&d.set(String(l.name),l)});const f=l=>!l.prodOpt1Id||String(l.prodOpt1Id).trim()==="",u=l=>n.has(String(l.prodOpt1Id));return(n.size&&t.some(u)?t.filter(l=>f(l)||u(l)):t).slice().sort((l,P)=>(P.isThumb==="Y")-(l.isThumb==="Y")||(l.sortOrd||0)-(P.sortOrd||0)).map((l,P)=>{const ce=l.prodOpt1Id!=null?s.get(String(l.prodOpt1Id)):null,fe=l.prodOpt2Id!=null?d.get(String(l.prodOpt2Id)):null,A=[];return ce&&A.push((e.opt1Nm||"\uC0C9\uC0C1")+": "+ce.name),fe&&A.push((e.opt2Nm||"\uC0AC\uC774\uC988")+": "+fe.name),l.isThumb==="Y"&&A.push("\u2605 \uB300\uD45C"),{src:coUtil.cofImgSrc(l.cdnImgUrl||l.cdnThumbUrl||l.previewUrl||""),label:"\uC774\uBBF8\uC9C0 "+(P+1),optTip:A.join(" / "),isMain:l.isThumb==="Y"}}).filter(l=>l.src)}if(!o.prodApiLoaded)return[];const r=(e.opt1s||[]).findIndex(a=>{var n;return a.name===((n=o.selectedColor)==null?void 0:n.name)});return Re(e,Math.max(0,r))}),Be=e=>{var d,f;const t=Number(e.rating)||0,i=e.reviewDate||e.regDate||"",r=i?coUtil.cofYmdDot(i):"",a=e.memberId||"",n=a.length>=3?a[0]+"*".repeat(a.length-2)+a.slice(-1):a.length===2?a[0]+"*":a||"***",s=m.filter(u=>u.reviewId===e.reviewId);return{id:e.reviewId,maskedName:n,rating:t,date:r,sizeInfo:e.prodOptNm2||e.sizeInfo||"",colorInfo:e.prodOptNm1||e.colorInfo||"",text:e.reviewContent||e.reviewTitle||"",hasPhoto:s.length>0,photoImg:coUtil.cofImgSrc(((d=s[0])==null?void 0:d.thumbUrl)||((f=s[0])==null?void 0:f.cdnImgUrl)||""),helpful:Number(e.helpfulCnt)||0}},b=c(()=>z.map(Be)),h=c(()=>b.value.filter(e=>e.hasPhoto)),Ie=c(()=>{const e=[...b.value];return o.reviewFilter==="\uBCC4\uC810\uB192\uC740\uC21C"?e.sort((t,i)=>i.rating-t.rating):o.reviewFilter==="\uBCC4\uC810\uB0AE\uC740\uC21C"?e.sort((t,i)=>t.rating-i.rating):o.reviewFilter==="\uB3C4\uC6C0\uC21C"?e.sort((t,i)=>i.helpful-t.helpful):e}),Pe=c(()=>{const e=Number(v.avgRating||v.avg_rating);if(e)return e.toFixed(1);const t=b.value;return t.length?(t.reduce((i,r)=>i+r.rating,0)/t.length).toFixed(1):"0.0"}),Ae=c(()=>[5,4,3,2,1].map(e=>({star:e,count:Number(v["rate"+e])||b.value.filter(t=>t.rating===e).length,pct:(()=>{const t=Number(v.total)||b.value.length,i=Number(v["rate"+e])||b.value.filter(r=>r.rating===e).length;return t?Math.round(i/t*100):0})()}))),Ce=e=>{const t=Math.max(0,Math.min(5,Number(e)||0)),i=Math.floor(t),r=t-i,a=r>=.25&&r<.75?1:0,n=r>=.75?i+1:i,s=5-n-a;return'<span style="color:#f59e0b;">\u2605</span>'.repeat(n)+(a?'<span style="position:relative;display:inline-block;color:#e5e7eb;">\u2605<span style="position:absolute;left:0;top:0;width:50%;overflow:hidden;color:#f59e0b;">\u2605</span></span>':"")+'<span style="color:#e5e7eb;">\u2605</span>'.repeat(s)};let ie=null;const y=()=>ie||(ie=document.querySelector(".layout-main"))||window;let re=0;const je=()=>{const e=y();if(!e.getBoundingClientRect)return;const t=e.getBoundingClientRect();o.tabFixedTop=t.top,o.tabFixedLeft=t.left,o.tabFixedW=t.width},Le=e=>{var u,$;const i=(u={detail:T,size:O,review:D,qna:N,style:U}[e])==null?void 0:u.value;if(!i)return;const r=y(),a=r.getBoundingClientRect?r.getBoundingClientRect():{top:0},n=(($=G.value)==null?void 0:$.offsetHeight)||44,s=(o.tabFixed,n+8),d=i.getBoundingClientRect().top-a.top,f=r.scrollTop+d-s;r.scrollTo({top:f,behavior:"smooth"}),o.activeTab=e},ne=()=>{const e=y(),t=G.value;if(!t||!e.getBoundingClientRect)return;const i=e.getBoundingClientRect().top;o.tabFixed?e.scrollTop<re&&(o.tabFixed=!1):t.getBoundingClientRect().top<=i&&(o.tabPlaceholderH=t.offsetHeight,re=e.scrollTop,je(),o.tabFixed=!0);const r=ee.value;o.showBottomBar=r?r.getBoundingClientRect().bottom<i:!1;const a=t.offsetHeight||44,n=o.tabFixed?o.tabFixedTop+a+20:t.getBoundingClientRect().bottom+10,s=[{id:"style",ref:U},{id:"qna",ref:N},{id:"review",ref:D},{id:"size",ref:O},{id:"detail",ref:T}];for(const d of s)if(d.ref.value&&d.ref.value.getBoundingClientRect().top<=n){o.activeTab=d.id;break}},H=()=>o.zoomOpen||o.photoPopupOpen||!!o.selectedReview||o.showSizeGuide||o.quickBuyOpen,ae=()=>{o.zoomOpen=!1,o.photoPopupOpen=!1,o.selectedReview=null,o.showSizeGuide=!1,o.quickBuyOpen=!1},se=e=>{e.key==="Escape"&&H()&&(e.preventDefault(),ae())},le=()=>{H()&&ae()};C(H,(e,t)=>{if(e&&!t)try{history.pushState({modal:!0},"")}catch{}}),ge(async()=>{y().addEventListener("scroll",ne,{passive:!0}),window.addEventListener("keydown",se),window.addEventListener("popstate",le);const t=(p.opt1s||[]).find(i=>I(i)==="ok");t&&(o.selectedColor=t),ye()}),V(()=>{y().removeEventListener("scroll",ne),window.removeEventListener("keydown",se),window.removeEventListener("popstate",le)}),C(()=>j,e=>{L(e),o.selectedColor=((e==null?void 0:e.opt1s)||[]).find(t=>I(t)==="ok")||null,o.selectedSize=null,o.qty=1,o.selectedImg=0,o.activeTab="detail",o.quickBuyOpen=!1,o.tabFixed=!1,y().scrollTo(0,0)});const qe=e=>{var t,i;return e&&(((i=(((t=window.SITE_CONFIG)==null?void 0:t.categorys)||[]).find(r=>r.categoryId===e.categoryId))==null?void 0:i.categoryNm)||e.categoryId)||""},Me=c(()=>{const e=p;if(!e)return{};const t=e.opt1s||[],i=e.prodId||1,r={};return t.forEach((a,n)=>{const s=(i*11+n*17)%25;s===0?r[a.name]="stop":s===1?r[a.name]="soldout":r[a.name]="ok"}),r}),I=e=>Me.value[e==null?void 0:e.name]||"ok",Ee=c(()=>{const e=p;if(!e)return{};const t=e.opt2s||[],i=e.prodId||1,r={};return t.forEach((a,n)=>{const s=(i*7+n*13)%20;s===0?r[a]="stop":s===1?r[a]="soldout":r[a]="ok"}),r}),de=e=>Ee.value[e]||"ok",w=c(()=>{const e=String(p.price||"").replace(/[^0-9]/g,"");return Number(e)||0}),Y=e=>(p.opt2Prices||{})[e]||0,pe=c(()=>{var i;const e=((i=o.selectedColor)==null?void 0:i.priceDelta)||0,t=Y(o.selectedSize);return w.value+e+t}),Q=c(()=>{const e=p;if(!e||!w.value)return null;const t=(e.opt1s||[]).map(s=>s.priceDelta||0),i=Object.values(e.opt2Prices||{}).concat([0]),r=[];t.forEach(s=>i.forEach(d=>r.push(w.value+s+d)));const a=Math.min(...r),n=Math.max(...r);return a===n?null:{min:a,max:n}}),Fe=c(()=>{var a;const e=p;if(!e||!w.value)return(e==null?void 0:e.price)||"";const t=((a=o.selectedColor)==null?void 0:a.priceDelta)||0,i=Y(o.selectedSize),r=Object.keys(e.opt2Prices||{}).length>0;if(o.selectedColor&&o.selectedSize)return(w.value+t+i).toLocaleString("ko-KR")+"\uC6D0";if(o.selectedColor){const n=w.value+t;if(r){const s=Math.max(...Object.values(e.opt2Prices));return n.toLocaleString("ko-KR")+"\uC6D0 ~ "+(n+s).toLocaleString("ko-KR")+"\uC6D0"}return n.toLocaleString("ko-KR")+"\uC6D0"}return Q.value?Q.value.min.toLocaleString("ko-KR")+"\uC6D0 ~ "+Q.value.max.toLocaleString("ko-KR")+"\uC6D0":e.price}),Ge=c(()=>p.prodId?pe.value?(pe.value*o.qty).toLocaleString("ko-KR")+"\uC6D0":p.price:""),Te=e=>{const t=I(e);t==="stop"||t==="soldout"||(o.selectedColor=e,o.colorError="",o.selectedImg=0)},Oe=e=>{const t=de(e);t==="stop"||t==="soldout"||(o.selectedSize=e,o.sizeError="")},_=()=>{let e=!0;o.selectedColor||((p.opt1s||[]).length>0?(o.colorError="\uC0C9\uC0C1\uC744 \uC120\uD0DD\uD574\uC8FC\uC138\uC694.",e=!1):p.prodTypeCd==="OPTION"?(o.colorError="\uC635\uC158 \uC815\uBCF4\uAC00 \uC5C6\uB294 \uC0C1\uD488\uC785\uB2C8\uB2E4. \uAD00\uB9AC\uC790\uC5D0\uAC8C \uBB38\uC758\uD574 \uC8FC\uC138\uC694.",e=!1):o.selectedColor={name:"FREE",hex:"#e5e7eb",priceDelta:0});const t=p.opt2s||[];return o.selectedSize||(t.length===1&&t[0]==="FREE"||t.length===0?o.selectedSize="FREE":(o.sizeError="\uC0AC\uC774\uC988\uB97C \uC120\uD0DD\uD574\uC8FC\uC138\uC694.",e=!1)),e},De=()=>{var e;_()&&(X(p,o.selectedColor,o.selectedSize,o.qty),o.selectedColor=((e=p.opt1s)==null?void 0:e[0])||null,o.selectedSize=null,o.qty=1)},Ne=()=>{_()&&(o.quickBuyOpen=!1,S.navigate("order",{instantOrder:{prod:p,color:o.selectedColor,size:o.selectedSize,qty:o.qty}}))},Ue=()=>{var e;_()&&(X(p,o.selectedColor,o.selectedSize,o.qty),o.quickBuyOpen=!1,o.selectedColor=((e=p.opt1s)==null?void 0:e[0])||null,o.selectedSize=null,o.qty=1)},We=()=>{o.drawerMode="buy",o.quickBuyOpen=!0},He=()=>{o.drawerMode="cart",o.quickBuyOpen=!0},Ye=e=>{o.selectedReview=e,o.photoFromGrid=!0,o.photoPopupOpen=!1},Qe=e=>{o.selectedReview=e,o.photoFromGrid=!1},_e=()=>{o.selectedReview=null,o.photoFromGrid&&(o.photoPopupOpen=!0),o.photoFromGrid=!1},Ke=()=>{const e=h.value;if(!e.length)return;const t=e.findIndex(i=>{var r;return i.id===((r=o.selectedReview)==null?void 0:r.id)});o.selectedReview=e[(t-1+e.length)%e.length]},$e=()=>{const e=h.value;if(!e.length)return;const t=e.findIndex(i=>{var r;return i.id===((r=o.selectedReview)==null?void 0:r.id)});o.selectedReview=e[(t+1)%e.length]},Ve=c(()=>h.value.findIndex(t=>{var i;return t.id===((i=o.selectedReview)==null?void 0:i.id)})),K=c(()=>Math.max(1,Math.ceil(h.value.length/W))),Xe=c(()=>{const e=(o.photoGridPage-1)*W;return h.value.slice(e,e+W)}),Je=()=>{o.photoGridPage=o.photoGridPage>1?o.photoGridPage-1:K.value},Ze=()=>{o.photoGridPage=o.photoGridPage<K.value?o.photoGridPage+1:1};return{columns:te,uiState:o,codes:be,prod:p,svContents:q,svRels:M,svReviews:z,svReviewSummary:v,svReviewImages:m,svQnas:E,svPromotions:R,handleBtnAction:ve,handleSelectAction:ue,fnCallbackModal:J,cfMockImages:B,cfMockReviews:b,cfReviewsWithPhoto:h,cfFilteredReviews:Ie,cfAvgRating:Pe,cfRatingDist:Ae,cfQuickBuyTotal:Ge,cfDisplayPrice:Fe,cfPhotoNavIdx:Ve,cfPhotoGridPageCount:K,cfPhotoGridItems:Xe,sizeGuideRows:ke,sizeGuideColsShort:Se,styleItems:ze,TABS:we,tabBarRef:G,detailSecRef:T,sizeSecRef:O,reviewSecRef:D,qnaSecRef:N,styleSecRef:U,buyBtnRef:ee,getSizeDelta:Y,fnCategoryLabel:qe,stars:Ce,colorStatus:I,sizeStatus:de,isLiked:xe,toggleLike:Z}},template:`
