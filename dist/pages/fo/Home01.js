window.Home01={name:"Home",props:{navigate:{type:Function,required:!0}},emits:[],setup(r){const{computed:a,onMounted:f,onBeforeUnmount:m,reactive:x}=Vue,l=window.foApp.prods,s=e=>window.foApp.selectProd(e),p=e=>window.foApp.toggleLike(e),u=e=>{var t,i,g;return(g=(i=(t=window.foApp).isLiked)==null?void 0:i.call(t,e))!=null?g:!1},v=window.foApp.addToCart,d=coUtil.cofShakeCtl(),o=x({loading:!1,error:null,cartModalMode:!1,quickViewProduct:null,bannerIdx:0}),c=[{img:"assets/cdn/prod/img/slider/slider-1.jpg",title:"\uB098\uB9CC\uC758 \uC2A4\uD0C0\uC77C\uC744",sub:"\uC644\uC131\uD558\uC138\uC694",desc:"\uD2B8\uB80C\uB514\uD55C \uC758\uB958\uB97C \uD569\uB9AC\uC801\uC778 \uAC00\uACA9\uC73C\uB85C. \uC0C9\uC0C1\uACFC \uC0AC\uC774\uC988\uB97C \uC9C1\uC811 \uC120\uD0DD\uD574 \uB098\uB9CC\uC758 \uC2A4\uD0C0\uC77C\uC744 \uB9CC\uB4E4\uC5B4\uBCF4\uC138\uC694."},{img:"assets/cdn/prod/img/slider/slider-2.jpg",title:"2026 S/S",sub:"\uC2E0\uC0C1\uD488 \uCEEC\uB809\uC158",desc:"\uC62C \uBD04\xB7\uC5EC\uB984 \uC2DC\uC98C\uC744 \uBE5B\uB0BC \uC0C8\uB85C\uC6B4 \uCEEC\uB809\uC158\uC774 \uB3C4\uCC29\uD588\uC2B5\uB2C8\uB2E4. \uC9C0\uAE08 \uB9CC\uB098\uBCF4\uC138\uC694."},{img:"assets/cdn/prod/img/slider/slider-3.jpg",title:"\uD2B9\uBCC4\uD55C \uD61C\uD0DD",sub:"\uC2DC\uC98C \uC138\uC77C \uC9C4\uD589\uC911",desc:"\uC778\uAE30 \uC0C1\uD488 \uCD5C\uB300 50% \uD560\uC778! \uD55C\uC815 \uC218\uB7C9\uC73C\uB85C \uC900\uBE44\uB41C \uD2B9\uBCC4 \uD61C\uD0DD\uC744 \uB193\uCE58\uC9C0 \uB9C8\uC138\uC694."}],n=coUtil.cofBannerTimer(e=>{o.bannerIdx=e},()=>o.bannerIdx,c.length,2e4),b=window.SITE_CONFIG||{},h=(e,t={})=>{if(e==="page-goHome")return r.navigate("home");if(e==="page-goProdList")return r.navigate("prodList");if(e==="page-goBlog")return r.navigate("blog");if(e==="hero-set")return k(t);if(e==="quickViewModal-openCart"){o.quickViewProduct=t,o.cartModalMode=!0;return}else if(e==="quickViewModal-openView"){o.quickViewProduct=t,o.cartModalMode=!1;return}else if(e==="quickViewModal-close"){o.quickViewProduct=null,o.cartModalMode=!1;return}else console.warn("[handleBtnAction] unknown cmd:",e)},y=(e,t={},i={})=>{if(e==="categories-rowSelect")return r.navigate("prodList");if(e==="prods-rowSelect")return i.ctrlKey||i.metaKey||i.button===1?window.foApp.openNewWindow("prodView",t.prodId):s(t);if(e==="prods-rowLike")return d.fire(t),p(t);console.warn("[handleSelectAction] unknown cmd:",e)},w=(e,t,i)=>{if(e==="quick-view"){if(i==null){o.quickViewProduct=null,o.cartModalMode=!1;return}return}else console.warn("[fnCallbackModal] unknown popCmd:",e)},k=e=>n.set(e);f(async()=>{if(!document.getElementById("home-grid-styles")){const e=document.createElement("style");e.id="home-grid-styles",e.textContent=`
        ...
        `,document.head.appendChild(e)}n.start()}),m(()=>n.stop());const S=a(()=>(l||[]).filter(e=>e.originalPrice&&e.priceNum&&e.originalPrice>e.priceNum).slice(0,4)),P=a(()=>(l||[]).slice(0,8)),z={SINGLE:"\uB2E8\uD488",OPTION:"\uC635\uC158\uC0C1\uD488",SET:"\uC138\uD2B8\uC0C1\uD488",GROUP:"\uBB36\uC74C\uC0C1\uD488",GIFT:"\uC0AC\uC740\uD488"};return{uiState:o,banners:c,siteConfig:b,handleBtnAction:h,handleSelectAction:y,fnCallbackModal:w,cfAllHomeProds:P,cfSaleProds:S,isLiked:u,likeShake:d,fnProdTypeLabel:e=>e&&z[e.prodTypeCd]||"",selectProd:s,toggleLike:p,addToCart:v}},template:`
<fo-page bare>
  <!-- ===== \u25A0. \u2550\u2550 Hero Banner Slider \u2550\u2550 ================================ -->
