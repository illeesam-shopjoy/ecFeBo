window.Prod01View={name:"Prod01View",props:{navigate:{type:Function,required:!0}},setup(P){const{ref:x,reactive:u,computed:c,onMounted:ve,onBeforeUnmount:Z,watch:E}=Vue,m=window.foApp.selectedProd,ee=window.foApp.addToCart,xe=(e,t={})=>{if(e==="page-goHome")return P.navigate("home");if(e==="page-goProdList")return P.navigate("prodList");if(e==="page-goContact")return P.navigate("contact");if(e==="cart-add")return Ke();if(e==="order-buyNow")return Qe();if(e==="cart-addFromDrawer")return Ve();if(e==="quickBuy-openBuy")return _e();if(e==="quickBuy-openCart")return $e();if(e==="quickBuy-close"){o.quickBuyOpen=!1;return}else{if(e==="prod-toggleLike")return te(t);if(e==="prod-shareKakao")return oe();if(e==="qty-inc"){o.qty++;return}else if(e==="qty-dec"){o.qty>1&&o.qty--;return}else if(e==="sizeGuideModal-open"){o.showSizeGuide=!0;return}else if(e==="sizeGuideModal-close"){o.showSizeGuide=!1;return}else if(e==="zoomModal-open"){o.zoomOpen=!0;return}else if(e==="zoomModal-close"){o.zoomOpen=!1;return}else if(e==="gallery-prev"){o.selectedImg=(o.selectedImg-1+R.value.length)%R.value.length;return}else if(e==="gallery-next"){o.selectedImg=(o.selectedImg+1)%R.value.length;return}else if(e==="photoModal-open"){o.photoPopupOpen=!0;return}else if(e==="photoModal-close"){o.photoPopupOpen=!1;return}else{if(e==="photoGrid-prev")return rt();if(e==="photoGrid-next")return nt();if(e==="photoDetail-close")return Ze();if(e==="photoDetail-prev")return et();if(e==="photoDetail-next")return tt();console.warn("[handleBtnAction] unknown cmd:",e)}}},be=(e,t={})=>{if(e==="options-colorSelect")return We(t);if(e==="options-sizeSelect")return Ye(t);if(e==="tab-go")return je(t);if(e==="gallery-rowSelect"){o.selectedImg=t;return}else if(e==="reviews-filterSelect"){o.reviewFilter=t;return}else if(e==="photoGrid-rowGo"){o.photoGridPage=t;return}else{if(e==="reviews-photoGridRowSelect")return Xe(t);if(e==="reviews-photoListRowSelect")return Je(t);console.warn("[handleSelectAction] unknown cmd:",e)}},me=(e,t,i)=>{if(e==="size-guide"){if(i==null){o.showSizeGuide=!1;return}return}else console.warn("[fnCallbackModal] unknown popCmd:",e)},te=e=>window.foApp.toggleLike(e),oe=()=>{var e,t,i,r;try{const n=((t=(e=R.value)==null?void 0:e[0])==null?void 0:t.src)||"",l=n?/^https?:\/\//i.test(n)?n:window.location.origin+"/"+n.replace(/^\//,""):"";window.coExtSdk.shareKakao({title:m.prodNm||"ShopJoy \uC0C1\uD488",description:m.advrtStmt||"",imageUrl:l,url:window.seoUrl("/foui/prodDtl/"+encodeURIComponent(m.prodId))})}catch(n){(r=(i=window.foApp)==null?void 0:i.showToast)==null||r.call(i,n.message||"\uCE74\uCE74\uC624\uD1A1 \uACF5\uC720\uB97C \uC5F4 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.","error",0)}},he=e=>{var t,i,r;return(r=(i=(t=window.foApp).isLiked)==null?void 0:i.call(t,e))!=null?r:!1},o=u({loading:!1,error:null,selectedImg:0,selectedColor:null,selectedSize:null,qty:1,colorError:"",sizeError:"",activeTab:"detail",reviewFilter:"\uCD5C\uC2E0\uC21C",selectedReview:null,photoGridPage:1,tabFixed:!1,tabFixedTop:0,tabFixedLeft:0,tabFixedW:0,tabPlaceholderH:0,drawerMode:"buy",photoFromGrid:!1,showSizeGuide:!1,photoPopupOpen:!1,zoomOpen:!1,showBottomBar:!1,quickBuyOpen:!1,prodApiLoaded:!1});E(()=>o.showBottomBar,e=>{document.documentElement.style.setProperty("--fab-lift",e?"72px":"0px")}),Z(()=>{document.documentElement.style.setProperty("--fab-lift","0px")});const ye=u({}),p=u({}),j=e=>{Object.keys(p).forEach(t=>delete p[t]),e&&Object.assign(p,e)},we=(e,t,i,r)=>coUtil.cofMergeProdOpts(e,t,i,r);m&&j(m);const q=u([]),G=u([]),A=u([]),v=u({}),h=u([]),F=u([]),C=u({}),ke=()=>coUtil.cofProdIdFromUrl(),z=e=>{var t,i,r;return(r=(i=(t=e==null?void 0:e.data)==null?void 0:t.data)!=null?i:e==null?void 0:e.data)!=null?r:null},O=e=>{const t=z(e);return Array.isArray(t)?t:(t==null?void 0:t.pageList)||(t==null?void 0:t.list)||[]},Se=async(e="DEFAULT")=>{var r,n,l;const t=ke()||p.prodId;if(!t)return;try{const a=await foApiSvc.pdProd.getById(t,"\uC0C1\uD488\uC0C1\uC138","\uC0C1\uC138\uC870\uD68C"),d=z(a)||{},f=d.prod||d;if(f&&f.prodId){const g={groups:d.prodOptTypes||[],items:d.prodOpts||[]},B=d.prodSkus||[],ue=d.prodImgs||[],s=we(f,g,B,ue);j(s),foUtil.fofSetPageMeta({title:s.prodNm?s.prodNm+" | ShopJoy":void 0,description:s.advrtStmt||(s.prodNm?s.prodNm+" - ShopJoy\uC5D0\uC11C \uB9CC\uB098\uBCF4\uC138\uC694.":void 0)}),o.prodApiLoaded=!0,o.selectedColor||(o.selectedColor=(s.opt1s||[]).find(S=>I(S)==="ok")||((r=s.opt1s)==null?void 0:r[0])||null)}}catch(a){console.error("[handleSearchList:getById]",a),o.prodApiLoaded=!0}const i=await Promise.allSettled([foApiSvc.pdProd.getContents(t,"\uC0C1\uD488\uC0C1\uC138","\uC0C1\uC138\uC124\uBA85\uC870\uD68C"),foApiSvc.pdProd.getRels(t,"\uC0C1\uD488\uC0C1\uC138","\uC5F0\uAD00\uC0C1\uD488\uC870\uD68C"),foApiSvc.pdProd.getReviews(t,{pageNo:1,pageSize:20},"\uC0C1\uD488\uC0C1\uC138","\uB9AC\uBDF0\uC870\uD68C"),foApiSvc.pdProd.getReviewImages(t,"\uC0C1\uD488\uC0C1\uC138","\uB9AC\uBDF0\uC774\uBBF8\uC9C0\uC870\uD68C"),foApiSvc.pdProd.getQna(t,{pageNo:1,pageSize:20},"\uC0C1\uD488\uC0C1\uC138","Q&A\uC870\uD68C")]);if(i[0].status==="fulfilled"&&q.splice(0,q.length,...O(i[0].value)),i[1].status==="fulfilled"&&G.splice(0,G.length,...O(i[1].value)),i[2].status==="fulfilled"){const a=z(i[2].value)||{},d=((n=a.reviewPage)==null?void 0:n.pageList)||[];A.splice(0,A.length,...d),Object.keys(v).forEach(g=>delete v[g]),Object.assign(v,a.summary||{});const f=a.attachImages||[];h.splice(0,h.length,...f)}if(i[3].status==="fulfilled"){const a=O(i[3].value);h.splice(0,h.length,...a)}if(i[4].status==="fulfilled"){const a=z(i[4].value)||{};F.splice(0,F.length,...((l=a.qnaPage)==null?void 0:l.pageList)||a.pageList||(Array.isArray(a)?a:[]))}try{const a=await foApiSvc.pdProd.getPromotions(t,"\uC0C1\uD488\uC0C1\uC138","\uD504\uB85C\uBAA8\uC158\uC870\uD68C");Object.keys(C).forEach(d=>delete C[d]),Object.assign(C,z(a)||{})}catch(a){console.error("[handleSearchList:getPromotions]",a)}},ze=[{id:"detail",label:"\uC0C1\uC138\uC815\uBCF4"},{id:"size",label:"\uC0AC\uC774\uC988"},{id:"review",label:"\uC0C1\uD488\uD3C9"},{id:"qna",label:"Q&A"},{id:"style",label:"\uC2A4\uD0C0\uC77C"}],N=x(null),ie=x(null),D=x(null),U=x(null),H=x(null),W=x(null),Y=x(null),K=12,Re=[["XS","36","82","60"],["S","38","86","62"],["M","40","90","64"],["L","42","96","66"],["XL","44","102","68"],["XXL","46","108","70"]],re={};re.sizeGuideGrid=[{key:"s0",label:"\uC0AC\uC774\uC988",align:"center",fmt:(e,t)=>t[0]},{key:"s1",label:"\uC5B4\uAE68 (cm)",align:"center",fmt:(e,t)=>t[1]},{key:"s2",label:"\uAC00\uC2B4 (cm)",align:"center",fmt:(e,t)=>t[2]},{key:"s3",label:"\uCD1D\uC7A5 (cm)",align:"center",fmt:(e,t)=>t[3]}];const Ie=[{key:"s0",label:"\uC0AC\uC774\uC988",align:"center",fmt:(e,t)=>t[0]},{key:"s1",label:"\uC5B4\uAE68",align:"center",fmt:(e,t)=>t[1]},{key:"s2",label:"\uAC00\uC2B4",align:"center",fmt:(e,t)=>t[2]},{key:"s3",label:"\uCD1D\uC7A5",align:"center",fmt:(e,t)=>t[3]}],Be=[{emoji:"\u{1F456}",label:"\uCE90\uC8FC\uC5BC \uB8E9",desc:"\uB370\uB2D8 \uD32C\uCE20 + \uC2A4\uB2C8\uCEE4\uC988"},{emoji:"\u{1F457}",label:"\uD398\uBBF8\uB2CC \uB8E9",desc:"\uD50C\uB85C\uB7F4 \uC2A4\uCEE4\uD2B8\uC640 \uB9E4\uCE58"},{emoji:"\u{1F9E5}",label:"\uB808\uC774\uC5B4\uB4DC \uB8E9",desc:"\uC624\uBC84\uD54F \uC790\uCF13\uACFC \uD568\uAED8"},{emoji:"\u{1F45F}",label:"\uC2A4\uD3EC\uD2F0 \uB8E9",desc:"\uD2B8\uB799 \uD32C\uCE20 + \uC2A4\uB2C8\uCEE4\uC988"}],ne="assets/cdn/prod/img/shop/product",Pe=(e,t)=>{const i=e.prodId||1;if((i<=12?"fashion":"prod")==="fashion"){const l=((i-1)*3+t*3)%12+1;return[1,2,3].map(a=>{const d=(l-1+a-1)%12+1;return{src:`${ne}/fashion/fashion-${d}.webp`,label:"\uC774\uBBF8\uC9C0 "+a}})}const n=((i-1)*3+t*2)%23+1;return[0,1,2].map(l=>{const a=(n-1+l)%23+1;return{src:`${ne}/prod_${a}.png`,label:"\uC774\uBBF8\uC9C0 "+(l+1)}})},R=c(()=>{const e=p;if(!e)return[];const t=Array.isArray(e.images)?e.images:[];if(t.length){const n=o.selectedColor||null,l=new Set;n&&(n.optId&&l.add(String(n.optId)),n.val&&l.add(String(n.val)),n.name&&l.add(String(n.name)));const a=new Map;(e.opt1s||[]).forEach(s=>{s.optId&&a.set(String(s.optId),s),s.val&&a.set(String(s.val),s),s.name&&a.set(String(s.name),s)});const d=new Map;(e.opt2sAll||[]).forEach(s=>{s.optId&&d.set(String(s.optId),s),s.val&&d.set(String(s.val),s),s.name&&d.set(String(s.name),s)});const f=s=>!s.prodOpt1Id||String(s.prodOpt1Id).trim()==="",g=s=>l.has(String(s.prodOpt1Id));return(l.size&&t.some(g)?t.filter(s=>f(s)||g(s)):t).slice().sort((s,S)=>(S.isThumb==="Y")-(s.isThumb==="Y")||(s.sortOrd||0)-(S.sortOrd||0)).map((s,S)=>{const T=s.prodOpt1Id!=null?a.get(String(s.prodOpt1Id)):null,L=s.prodOpt2Id!=null?d.get(String(s.prodOpt2Id)):null,M=[];return T&&M.push((e.opt1Nm||"\uC0C9\uC0C1")+": "+T.name),L&&M.push((e.opt2Nm||"\uC0AC\uC774\uC988")+": "+L.name),s.isThumb==="Y"&&M.push("\u2605 \uB300\uD45C"),{src:coUtil.cofImgSrc(s.cdnImgUrl||s.cdnThumbUrl||s.previewUrl||""),label:"\uC774\uBBF8\uC9C0 "+(S+1),optTip:M.join(" / "),opt1Nm:T?T.name:"",opt2Nm:L?L.name:"",isMain:s.isThumb==="Y"}}).filter(s=>s.src)}if(!o.prodApiLoaded)return[];const r=(e.opt1s||[]).findIndex(n=>{var l;return n.name===((l=o.selectedColor)==null?void 0:l.name)});return Pe(e,Math.max(0,r))}),Ae=e=>{var d,f;const t=Number(e.rating)||0,i=e.reviewDate||e.regDate||"",r=i?coUtil.cofYmdDot(i):"",n=e.memberId||"",l=n.length>=3?n[0]+"*".repeat(n.length-2)+n.slice(-1):n.length===2?n[0]+"*":n||"***",a=h.filter(g=>g.reviewId===e.reviewId);return{id:e.reviewId,maskedName:l,rating:t,date:r,sizeInfo:e.prodOptNm2||e.sizeInfo||"",colorInfo:e.prodOptNm1||e.colorInfo||"",text:e.reviewContent||e.reviewTitle||"",hasPhoto:a.length>0,photoImg:coUtil.cofImgSrc(((d=a[0])==null?void 0:d.thumbUrl)||((f=a[0])==null?void 0:f.cdnImgUrl)||""),helpful:Number(e.helpfulCnt)||0}},b=c(()=>A.map(Ae)),y=c(()=>b.value.filter(e=>e.hasPhoto)),Ce=c(()=>{const e=[...b.value];return o.reviewFilter==="\uBCC4\uC810\uB192\uC740\uC21C"?e.sort((t,i)=>i.rating-t.rating):o.reviewFilter==="\uBCC4\uC810\uB0AE\uC740\uC21C"?e.sort((t,i)=>t.rating-i.rating):o.reviewFilter==="\uB3C4\uC6C0\uC21C"?e.sort((t,i)=>i.helpful-t.helpful):e}),Te=c(()=>{const e=Number(v.avgRating||v.avg_rating);if(e)return e.toFixed(1);const t=b.value;return t.length?(t.reduce((i,r)=>i+r.rating,0)/t.length).toFixed(1):"0.0"}),Le=c(()=>[5,4,3,2,1].map(e=>({star:e,count:Number(v["rate"+e])||b.value.filter(t=>t.rating===e).length,pct:(()=>{const t=Number(v.total)||b.value.length,i=Number(v["rate"+e])||b.value.filter(r=>r.rating===e).length;return t?Math.round(i/t*100):0})()}))),Me=e=>{const t=Math.max(0,Math.min(5,Number(e)||0)),i=Math.floor(t),r=t-i,n=r>=.25&&r<.75?1:0,l=r>=.75?i+1:i,a=5-l-n;return'<span style="color:#f59e0b;">\u2605</span>'.repeat(l)+(n?'<span style="position:relative;display:inline-block;color:#e5e7eb;">\u2605<span style="position:absolute;left:0;top:0;width:50%;overflow:hidden;color:#f59e0b;">\u2605</span></span>':"")+'<span style="color:#e5e7eb;">\u2605</span>'.repeat(a)};let se=null;const w=()=>se||(se=document.querySelector(".layout-main"))||window;let ae=0;const Ee=()=>{const e=w();if(!e.getBoundingClientRect)return;const t=e.getBoundingClientRect();o.tabFixedTop=t.top,o.tabFixedLeft=t.left,o.tabFixedW=t.width},je=e=>{var g,B;const i=(g={detail:D,size:U,review:H,qna:W,style:Y}[e])==null?void 0:g.value;if(!i)return;const r=w(),n=r.getBoundingClientRect?r.getBoundingClientRect():{top:0},l=((B=N.value)==null?void 0:B.offsetHeight)||44,a=(o.tabFixed,l+8),d=i.getBoundingClientRect().top-n.top,f=r.scrollTop+d-a;r.scrollTo({top:f,behavior:"smooth"}),o.activeTab=e},le=()=>{const e=w(),t=N.value;if(!t||!e.getBoundingClientRect)return;const i=e.getBoundingClientRect().top;o.tabFixed?e.scrollTop<ae&&(o.tabFixed=!1):t.getBoundingClientRect().top<=i&&(o.tabPlaceholderH=t.offsetHeight,ae=e.scrollTop,Ee(),o.tabFixed=!0);const r=ie.value;o.showBottomBar=r?r.getBoundingClientRect().bottom<i:!1;const n=document.querySelector("footer");n&&n.getBoundingClientRect().top<e.getBoundingClientRect().bottom&&(o.showBottomBar=!1);const l=t.offsetHeight||44,a=o.tabFixed?o.tabFixedTop+l+20:t.getBoundingClientRect().bottom+10,d=[{id:"style",ref:Y},{id:"qna",ref:W},{id:"review",ref:H},{id:"size",ref:U},{id:"detail",ref:D}];for(const f of d)if(f.ref.value&&f.ref.value.getBoundingClientRect().top<=a){o.activeTab=f.id;break}},Q=()=>o.zoomOpen||o.photoPopupOpen||!!o.selectedReview||o.showSizeGuide||o.quickBuyOpen,de=()=>{o.zoomOpen=!1,o.photoPopupOpen=!1,o.selectedReview=null,o.showSizeGuide=!1,o.quickBuyOpen=!1},pe=e=>{e.key==="Escape"&&Q()&&(e.preventDefault(),de())},ce=()=>{Q()&&de()};E(Q,(e,t)=>{if(e&&!t)try{history.pushState({modal:!0},"")}catch{}}),ve(async()=>{w().addEventListener("scroll",le,{passive:!0}),window.addEventListener("keydown",pe),window.addEventListener("popstate",ce);const t=(p.opt1s||[]).find(i=>I(i)==="ok");t&&(o.selectedColor=t),Se()}),Z(()=>{w().removeEventListener("scroll",le),window.removeEventListener("keydown",pe),window.removeEventListener("popstate",ce)}),E(()=>m,e=>{j(e),o.selectedColor=((e==null?void 0:e.opt1s)||[]).find(t=>I(t)==="ok")||null,o.selectedSize=null,o.qty=1,o.selectedImg=0,o.activeTab="detail",o.quickBuyOpen=!1,o.tabFixed=!1,w().scrollTo(0,0)});const qe=e=>{var t,i;return e&&(((i=(((t=window.SITE_CONFIG)==null?void 0:t.categorys)||[]).find(r=>r.categoryId===e.categoryId))==null?void 0:i.categoryNm)||e.categoryId)||""},Ge={SINGLE:"\uB2E8\uD488",OPTION:"\uC635\uC158\uC0C1\uD488",GROUP:"\uBB36\uC74C\uC0C1\uD488",SET:"\uC138\uD2B8\uC0C1\uD488",GIFT:"\uC0AC\uC740\uD488"},Fe=e=>e&&Ge[e.prodTypeCd]||"",Oe=c(()=>{const e=p;if(!e)return{};const t=e.opt1s||[],i=e.prodId||1,r={};return t.forEach((n,l)=>{const a=(i*11+l*17)%25;a===0?r[n.name]="stop":a===1?r[n.name]="soldout":r[n.name]="ok"}),r}),I=e=>Oe.value[e==null?void 0:e.name]||"ok",Ne=c(()=>{const e=p;if(!e)return{};const t=e.opt2s||[],i=e.prodId||1,r={};return t.forEach((n,l)=>{const a=(i*7+l*13)%20;a===0?r[n]="stop":a===1?r[n]="soldout":r[n]="ok"}),r}),V=c(()=>{var n;const e=p.opt2sAll||[];if(!e.length||!e.some(l=>l.parentOptId&&String(l.parentOptId).trim()))return null;const i=(n=o.selectedColor)==null?void 0:n.optId;if(!i)return new Set;const r=new Set;return e.forEach(l=>{l.parentOptId===i&&l.name&&r.add(l.name)}),r}),fe=e=>{const t=V.value;return t&&!t.has(e)?"stop":Ne.value[e]||"ok"},De=c(()=>{const e=p.opt2s||[],t=V.value;return t?e.filter(i=>t.has(i)):e}),k=c(()=>{const e=String(p.price||"").replace(/[^0-9]/g,"");return Number(e)||0}),_=e=>(p.opt2Prices||{})[e]||0,ge=c(()=>{var i;const e=((i=o.selectedColor)==null?void 0:i.priceDelta)||0,t=_(o.selectedSize);return k.value+e+t}),$=c(()=>{const e=p;if(!e||!k.value)return null;const t=(e.opt1s||[]).map(a=>a.priceDelta||0),i=Object.values(e.opt2Prices||{}).concat([0]),r=[];t.forEach(a=>i.forEach(d=>r.push(k.value+a+d)));const n=Math.min(...r),l=Math.max(...r);return n===l?null:{min:n,max:l}}),Ue=c(()=>{var n;const e=p;if(!e||!k.value)return(e==null?void 0:e.price)||"";const t=((n=o.selectedColor)==null?void 0:n.priceDelta)||0,i=_(o.selectedSize),r=Object.keys(e.opt2Prices||{}).length>0;if(o.selectedColor&&o.selectedSize)return(k.value+t+i).toLocaleString("ko-KR")+"\uC6D0";if(o.selectedColor){const l=k.value+t;if(r){const a=Math.max(...Object.values(e.opt2Prices));return l.toLocaleString("ko-KR")+"\uC6D0 ~ "+(l+a).toLocaleString("ko-KR")+"\uC6D0"}return l.toLocaleString("ko-KR")+"\uC6D0"}return $.value?$.value.min.toLocaleString("ko-KR")+"\uC6D0 ~ "+$.value.max.toLocaleString("ko-KR")+"\uC6D0":e.price}),He=c(()=>p.prodId?ge.value?(ge.value*o.qty).toLocaleString("ko-KR")+"\uC6D0":p.price:""),We=e=>{const t=I(e);if(t==="stop"||t==="soldout")return;o.selectedColor=e,o.colorError="",o.selectedImg=0;const i=V.value;i&&o.selectedSize&&!i.has(o.selectedSize)&&(o.selectedSize=null)},Ye=e=>{const t=fe(e);t==="stop"||t==="soldout"||(o.selectedSize=e,o.sizeError="")},X=()=>{let e=!0;o.selectedColor||((p.opt1s||[]).length>0?(o.colorError="\uC0C9\uC0C1\uC744 \uC120\uD0DD\uD574\uC8FC\uC138\uC694.",e=!1):p.prodTypeCd==="OPTION"?(o.colorError="\uC635\uC158 \uC815\uBCF4\uAC00 \uC5C6\uB294 \uC0C1\uD488\uC785\uB2C8\uB2E4. \uAD00\uB9AC\uC790\uC5D0\uAC8C \uBB38\uC758\uD574 \uC8FC\uC138\uC694.",e=!1):o.selectedColor={name:"FREE",hex:"#e5e7eb",priceDelta:0});const t=p.opt2s||[];return o.selectedSize||(t.length===1&&t[0]==="FREE"||t.length===0?o.selectedSize="FREE":(o.sizeError="\uC0AC\uC774\uC988\uB97C \uC120\uD0DD\uD574\uC8FC\uC138\uC694.",e=!1)),e},Ke=()=>{var e;X()&&(ee(p,o.selectedColor,o.selectedSize,o.qty),o.selectedColor=((e=p.opt1s)==null?void 0:e[0])||null,o.selectedSize=null,o.qty=1)},Qe=()=>{X()&&(o.quickBuyOpen=!1,P.navigate("order",{instantOrder:{prod:p,color:o.selectedColor,size:o.selectedSize,qty:o.qty}}))},Ve=()=>{var e;X()&&(ee(p,o.selectedColor,o.selectedSize,o.qty),o.quickBuyOpen=!1,o.selectedColor=((e=p.opt1s)==null?void 0:e[0])||null,o.selectedSize=null,o.qty=1)},_e=()=>{o.drawerMode="buy",o.quickBuyOpen=!0},$e=()=>{o.drawerMode="cart",o.quickBuyOpen=!0},Xe=e=>{o.selectedReview=e,o.photoFromGrid=!0,o.photoPopupOpen=!1},Je=e=>{o.selectedReview=e,o.photoFromGrid=!1},Ze=()=>{o.selectedReview=null,o.photoFromGrid&&(o.photoPopupOpen=!0),o.photoFromGrid=!1},et=()=>{const e=y.value;if(!e.length)return;const t=e.findIndex(i=>{var r;return i.id===((r=o.selectedReview)==null?void 0:r.id)});o.selectedReview=e[(t-1+e.length)%e.length]},tt=()=>{const e=y.value;if(!e.length)return;const t=e.findIndex(i=>{var r;return i.id===((r=o.selectedReview)==null?void 0:r.id)});o.selectedReview=e[(t+1)%e.length]},ot=c(()=>y.value.findIndex(t=>{var i;return t.id===((i=o.selectedReview)==null?void 0:i.id)})),J=c(()=>Math.max(1,Math.ceil(y.value.length/K))),it=c(()=>{const e=(o.photoGridPage-1)*K;return y.value.slice(e,e+K)}),rt=()=>{o.photoGridPage=o.photoGridPage>1?o.photoGridPage-1:J.value},nt=()=>{o.photoGridPage=o.photoGridPage<J.value?o.photoGridPage+1:1};return{columns:re,uiState:o,codes:ye,prod:p,svContents:q,svRels:G,svReviews:A,svReviewSummary:v,svReviewImages:h,svQnas:F,svPromotions:C,handleBtnAction:xe,handleSelectAction:be,fnCallbackModal:me,cfMockImages:R,cfMockReviews:b,cfReviewsWithPhoto:y,cfFilteredReviews:Ce,cfAvgRating:Te,cfRatingDist:Le,cfQuickBuyTotal:He,cfDisplayPrice:Ue,cfVisibleSizes:De,cfPhotoNavIdx:ot,cfPhotoGridPageCount:J,cfPhotoGridItems:it,sizeGuideRows:Re,sizeGuideColsShort:Ie,styleItems:Be,TABS:ze,tabBarRef:N,detailSecRef:D,sizeSecRef:U,reviewSecRef:H,qnaSecRef:W,styleSecRef:Y,buyBtnRef:ie,getSizeDelta:_,fnCategoryLabel:qe,fnProdTypeLabel:Fe,stars:Me,colorStatus:I,sizeStatus:fe,isLiked:he,toggleLike:te,handleShareKakao:oe}},template:`
