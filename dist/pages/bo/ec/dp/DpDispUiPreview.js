const _WP_DispUiPreview={name:"WidgetPreview",props:{lib:Object,compact:{type:Boolean,default:!1}},setup(C){const{ref:E,reactive:p,computed:b,watchEffect:Y,watch:U,onMounted:R}=Vue;return{cfChartBars:b(()=>coUtil.cofChartBars((C.lib||{}).chartValues,(C.lib||{}).chartLabels)),coUtil}},template:`
...
<!-- ===== \u25A1. \uAE30\uD0C0 ====================================================== -->
`};window.DpDispUiPreview={name:"DpDispUiPreview",props:{navigate:{type:Function,required:!0}},setup(C){const{ref:E,reactive:p,computed:b,watch:Y,watchEffect:U,onMounted:R}=Vue,L=window.boApp.showToast,Ee=window.boApp.showConfirm,Ue=window.boApp.showRefModal,P=p({disp_widget_types:[],active_statuses:[{codeValue:"\uD65C\uC131",codeLabel:"\uD65C\uC131"},{codeValue:"\uBE44\uD65C\uC131",codeLabel:"\uBE44\uD65C\uC131"}],visibility_opts:[{value:"",label:"\uC804\uCCB4"},{value:"PUBLIC",label:"\uC804\uCCB4\uACF5\uAC1C"},{value:"MEMBER",label:"\uD68C\uC6D0\uACF5\uAC1C"},{value:"VERIFIED",label:"\uC778\uC99D\uD68C\uC6D0"},{value:"PREMIUM",label:"\uC6B0\uC218\uD68C\uC6D0\u2191"},{value:"VIP",label:"VIP\uC804\uC6A9"},{value:"INVITED",label:"\uCD08\uB300\uD68C\uC6D0"},{value:"STAFF",label:"\uC9C1\uC6D0"},{value:"EXECUTIVE",label:"\uC784\uC9C1\uC6D0"}]}),z=p([]),D=p({displays:[],codes:[]}),o=p({selectedLibId:null,previewGrid:"grid1",viewportMode:"desktop",dragOverIdx:-1,spanPopupIdx:-1}),F=b(()=>boUtil.bofGetSiteNm()),M=coUtil.cofToYmd(new Date),$=new Date().toTimeString().slice(0,5),f=p({previewDate:"",previewTime:"",filterType:"",filterStatus:"",filterVisibility:"",filterDispEnv:"",searchType:"",searchValue:""}),G={},y=p({type:"",status:"\uD65C\uC131",dispEnv:"PROD",searchType:"",searchValue:"",visibility:""}),H=(e,t={})=>{if(e==="searchParam-apply")return ee();if(e==="searchParam-reset")return te();if(e==="pathTree-expand-all")return re();if(e==="pathTree-collapse-all")return pe();if(e==="preview-reset")return N();if(e==="preview-toggle-real"){w.showRealContent=!w.showRealContent;return}else{if(e==="preview-close-span")return ze();console.warn("[handleBtnAction] unknown cmd:",e)}},X=(e,t={})=>{if(e==="pathTree-toggle")return se(t);if(e==="pathTree-select")return ae(t);if(e==="preview-grid"){o.previewGrid=t;return}else if(e==="preview-viewport"){o.viewportMode=t;return}else{if(e==="preview-span-popup")return _e(t.e,t.idx);if(e==="preview-span-set")return Se(t.idx,t.axis,t.delta);if(e==="preview-slot-remove")return ke(t);if(e==="preview-dash-remove")return Ce(t);console.warn("[handleSelectAction] unknown cmd:",e)}},q=async()=>{const e=window.sfGetBoCodeStore();await e.saLoadCodes(["WIDGET_TYPE_CD"],{compNm:"DpDispUiPreview"}),P.disp_widget_types=e.sgGetGrpCodes("WIDGET_TYPE_CD")},J=async()=>{var e,t,i,a,s,r;try{const[d,v,c]=await Promise.all([boApiSvc.dpUi.getPage({pageNo:1,pageSize:1e4},"\uC804\uC2DCUI\uBBF8\uB9AC\uBCF4\uAE30","\uC870\uD68C"),boApiSvc.dpArea.getPage({pageNo:1,pageSize:1e4},"\uC804\uC2DCUI\uBBF8\uB9AC\uBCF4\uAE30","\uC601\uC5ED\uC870\uD68C"),boApiSvc.dpPanel.getPage({pageNo:1,pageSize:1e4},"\uC804\uC2DCUI\uBBF8\uB9AC\uBCF4\uAE30","\uD328\uB110\uC870\uD68C")]),x=((t=(e=d.data)==null?void 0:e.data)==null?void 0:t.pageList)||[],u=((a=(i=v.data)==null?void 0:i.data)==null?void 0:a.pageList)||[],T=((r=(s=c.data)==null?void 0:s.data)==null?void 0:r.pageList)||[];z.splice(0,z.length,...x);const O=Object.fromEntries(x.map(n=>[n.uiId,n.uiCd]));D.codes=u.map((n,_)=>({codeGrp:"DISP_AREA",codeValue:n.areaCd,codeLabel:n.areaNm,uiCode:O[n.uiId]||"",sortOrd:_,layoutType:"grid",gridCols:1,titleYn:"N"}));const S=Object.fromEntries(u.map(n=>[n.areaId,n.areaCd]));D.displays=T.map((n,_)=>{const Oe=coUtil.cofParsePanelRows(n.contentJson);return{dispId:n.panelId,name:n.panelNm,area:S[n.areaId]||"",status:coUtil.cofPanelStatusLabel(n.dispPanelStatusCd),rows:Oe,sortOrder:_+1,dispYn:"Y",useYn:n.useYn,useStartDate:coUtil.cofYmd(n.useStartDate),useEndDate:coUtil.cofYmd(n.useEndDate),dispStartDt:"",dispEndDt:"",dispEnv:"",visibilityTargets:n.visibilityTargets||"",layoutType:"grid",gridCols:1,titleYn:"N",title:""}})}catch(d){console.error("[handleSearchList]",d)}};R(async()=>{Object.assign(f,{previewDate:M,previewTime:$,filterStatus:"\uD65C\uC131",filterDispEnv:"PROD"}),await q(),await J(),Object.assign(G,f)});const K={image_banner:"\u{1F5BC}",product_slider:"\u{1F6D2}",product:"\u{1F4E6}",cond_product:"\u{1F50D}",chart_bar:"\u{1F4CA}",chart_line:"\u{1F4C8}",chart_pie:"\u{1F967}",text_banner:"\u{1F4DD}",info_card:"\u2139\uFE0F",popup:"\u{1F4AC}",file:"\u{1F4CE}",file_list:"\u{1F4C1}",coupon:"\u{1F39F}",html_editor:"\u{1F4C4}",event_banner:"\u{1F389}",cache_banner:"\u{1F4B0}",widget_embed:"\u{1F9E9}",textarea:"\u{1F4CB}",markdown:"\u{1F4D1}",barcode:"\u{1F516}",qrcode:"\u{1F4F1}",barcode_qrcode:"\u{1F516}",video_player:"\u25B6\uFE0F",countdown:"\u23F1",payment_widget:"\u{1F4B3}",approval_widget:"\u2705",map_widget:"\u{1F5FA}"},Q=e=>K[e]||"\u25AA",Z=e=>{var t;return((t=P.disp_widget_types.find(i=>i.codeValue===e))==null?void 0:t.codeLabel)||e},ee=()=>{Object.assign(y,{type:f.filterType,status:f.filterStatus,dispEnv:f.filterDispEnv,searchType:f.searchType,searchValue:(f.searchValue||"").trim().toLowerCase(),visibility:f.filterVisibility})},te=()=>{Object.assign(f,G),Object.assign(y,{type:"",status:"\uD65C\uC131",dispEnv:"PROD",searchType:"",searchValue:"",visibility:""}),N()},ie=e=>({libId:e.uiId,uiId:e.uiId,uiCode:e.uiCd,name:`${e.uiCd||""} ${e.uiNm||""}`.trim(),widgetType:"-",deviceTypeCd:e.deviceTypeCd,status:e.useYn==="Y"?"\uD65C\uC131":"\uBE44\uD65C\uC131"}),j=b(()=>{const e=y.searchValue;return z.map(ie).filter(t=>!(y.status&&t.status!==y.status||e&&!(t.name||"").toLowerCase().includes(e)))}),ae=e=>{o.selectedLibId=e.libId},oe={PC:"\u{1F5A5} PC",MOBILE:"\u{1F4F1} \uBAA8\uBC14\uC77C",TABLET:"\u{1F4DF} \uD0DC\uBE14\uB9BF",ALL:"\u{1F310} \uC804\uCCB4 \uB514\uBC14\uC774\uC2A4"},I=b(()=>{const e={};return j.value.forEach(t=>{const i=oe[t.deviceTypeCd]||t.deviceTypeCd||"(\uBBF8\uBD84\uB958)",a=t.uiCode||t.name;e[i]||(e[i]={}),e[i][a]||(e[i][a]=[]),e[i][a].push(t)}),Object.keys(e).sort().map(t=>({label:t,children:Object.keys(e[t]).sort().map(i=>({label:i,libs:e[t][i]}))}))}),ne=e=>D.codes.filter(t=>t.uiCode===e).map(t=>t.codeValue),l=p(new Set),se=e=>{l.has(e)?l.delete(e):l.add(e)},le=e=>l.has(e),B=e=>e.children.every(t=>l.has(e.label+"_"+t.label)),de=(e,t)=>{e.stopPropagation();const i=!B(t);window.safeArrayUtils.safeForEach(t.children,a=>{const s=t.label+"_"+a.label;i?l.add(s):l.delete(s)}),i&&l.add(t.label)};U(()=>{l.has("__root__")||l.add("__root__");const e=Array.isArray(I.value)?I.value:[];if(e.length&&l.size===1){const t=e[0];t&&t.label&&l.add(t.label)}});const re=()=>{window.safeArrayUtils.safeForEach(I.value,e=>l.add(e.label)),l.add("__root__")},pe=()=>{l.clear(),l.add("__root__")},ce=(e,t)=>{window._dragWidgetLib=t,window._dragWidgetLibs=null,e.dataTransfer.effectAllowed="copy",e.dataTransfer.setData("text/plain",t.libId)},fe=()=>{window._dragWidgetLib=null},xe=e=>{const t=new Set;return window.safeArrayUtils.safeFilter(e,i=>t.has(i.libId)?!1:(t.add(i.libId),!0))},be=(e,t)=>{const i=xe(t);window._dragWidgetLib=null,window._dragWidgetLibs=i,e.dataTransfer.effectAllowed="copy",e.dataTransfer.setData("text/plain","node:"+i.length)},ge=()=>{window._dragWidgetLibs=null},ve=[{id:"grid1",label:"grid1",cols:1},{id:"grid2",label:"grid2",cols:2},{id:"grid3",label:"grid3",cols:3},{id:"grid4",label:"grid4",cols:4},{id:"dashboard",label:"dashboard",cols:null}],m={grid1:1,grid2:2,grid3:3,grid4:4},ue={desktop:{label:"\u{1F5A5} PC",width:null},tablet:{label:"\u{1F4DF} \uD0DC\uBE14\uB9BF",width:"768px"},mobile:{label:"\u{1F4F1} \uBAA8\uBC14\uC77C",width:"375px"}},he=b(()=>({grid1:"repeat(1,1fr)",grid2:"repeat(auto-fill,minmax(max(calc(50% - 5px),260px),1fr))",grid3:"repeat(auto-fill,minmax(max(calc(33.333% - 6px),190px),1fr))",grid4:"repeat(auto-fill,minmax(max(calc(25% - 6px),220px),1fr))"})[o.previewGrid]||"repeat(1,1fr)"),w=p({dashDragOver:!1,showRealContent:!1}),k=e=>Array(e*2).fill(null),g=p({grid1:k(1),grid2:k(2),grid3:k(3),grid4:k(4)}),V=b(()=>g[o.previewGrid]||[]),W=e=>{const t=m[e];if(!t)return;const i=g[e],a=i.length-t;if(i.slice(a).some(Boolean))for(let s=0;s<t;s++)i.push(null)},ye=(e,t)=>{e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect="copy"),o.dragOverIdx!==t&&(o.dragOverIdx=t)},we=(e,t)=>{const i=e&&e.relatedTarget;i&&e.currentTarget&&e.currentTarget.contains(i)||o.dragOverIdx===t&&(o.dragOverIdx=-1)},me=(e,t)=>{e.preventDefault(),o.dragOverIdx=-1;const i=window._dragWidgetLibs;if(i){if(window._dragWidgetLibs=null,i.length>40){L(`\uB178\uB4DC \uD558\uC704 \uC704\uC82F\uC774 ${i.length}\uAC1C\uB85C 40\uAC1C\uB97C \uCD08\uACFC\uD569\uB2C8\uB2E4. \uBC30\uCE58\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.`,"error");return}const r=o.previewGrid,d=g[r],v=m[r]||1;let c=0,x=t;for(;c<i.length;){if(x>=d.length)for(let u=0;u<v;u++)d.push(null);d[x]||(d.splice(x,1,{...i[c],colSpan:1,rowSpan:1}),c++),x++}W(r);return}const a=window._dragWidgetLib;if(!a)return;const s=o.previewGrid;g[s].splice(t,1,{...a,colSpan:1,rowSpan:1}),W(s)},ke=e=>{g[o.previewGrid].splice(e,1,null)},Se=(e,t,i)=>{const a=g[o.previewGrid][e];if(!a)return;const s=m[o.previewGrid]||1;t==="col"&&(a.colSpan=Math.max(1,Math.min(s,(a.colSpan||1)+i))),t==="row"&&(a.rowSpan=Math.max(1,Math.min(4,(a.rowSpan||1)+i)))},_e=(e,t)=>{e.stopPropagation(),o.spanPopupIdx=o.spanPopupIdx===t?-1:t},ze=()=>{o.spanPopupIdx=-1},A=E(null),h=p([]),De=e=>{e.preventDefault(),w.dashDragOver=!0},Ie=()=>{w.dashDragOver=!1},Te=e=>{if(e.preventDefault(),w.dashDragOver=!1,!A.value)return;const t=A.value.getBoundingClientRect(),i=window._dragWidgetLibs;if(i){if(window._dragWidgetLibs=null,i.length>40){L(`\uB178\uB4DC \uD558\uC704 \uC704\uC82F\uC774 ${i.length}\uAC1C\uB85C 40\uAC1C\uB97C \uCD08\uACFC\uD569\uB2C8\uB2E4. \uBC30\uCE58\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.`,"error");return}const d=Math.max(0,e.clientX-t.left-120),v=Math.max(0,e.clientY-t.top-20),c=3,x=260,u=200,T=10;window.safeArrayUtils.safeForEach(i,(O,S)=>{const n=S%c,_=Math.floor(S/c);h.push({id:Date.now()+S,lib:{...O},x:d+n*(x+T),y:v+_*(u+T),w:x,h:u})});return}const a=window._dragWidgetLib;if(!a)return;const s=Math.max(0,e.clientX-t.left-110),r=Math.max(0,e.clientY-t.top-20);h.push({id:Date.now(),lib:{...a},x:s,y:r,w:240,h:180})},Ce=e=>{const t=h.findIndex(i=>i.id===e);t>=0&&h.splice(t,1)},Le=(e,t)=>{e.preventDefault();const i=e.clientX-t.x,a=e.clientY-t.y,s=d=>{t.x=Math.max(0,d.clientX-i),t.y=Math.max(0,d.clientY-a)},r=()=>{document.removeEventListener("mousemove",s),document.removeEventListener("mouseup",r)};document.addEventListener("mousemove",s),document.addEventListener("mouseup",r)},Pe=(e,t)=>{e.preventDefault(),e.stopPropagation();const i=e.clientX,a=e.clientY,s=t.w,r=t.h,d=c=>{t.w=Math.max(160,s+(c.clientX-i)),t.h=Math.max(120,r+(c.clientY-a))},v=()=>{document.removeEventListener("mousemove",d),document.removeEventListener("mouseup",v)};document.addEventListener("mousemove",d),document.addEventListener("mouseup",v)},Ae=b(()=>o.previewGrid==="dashboard"?h.length:window.safeArrayUtils.safeFilter(V.value,Boolean).length),N=()=>{if(o.previewGrid==="dashboard")h.splice(0);else{const e=m[o.previewGrid],t=g[o.previewGrid];t.splice(0,t.length,...k(e))}};return{codes:P,searchParam:f,applied:y,uis:z,dispData:D,uiState:o,gridState:w,tabSlots:g,dashCanvas:A,dashItems:h,openNodes:l,handleBtnAction:H,handleSelectAction:X,cfSiteNm:F,cfFilteredLibs:j,cfTree:I,cfAutoGridColumns:he,cfCurrentSlots:V,cfPlacedCount:Ae,GRID_TABS:ve,GRID_COLS:m,VIEWPORT:ue,wIcon:Q,wTypeLabel:Z,isOpen:le,allChildrenOpen:B,fnUiAreas:ne,toggleAllChildren:de,onItemDragStart:ce,onItemDragEnd:fe,onNodeDragStart:be,onNodeDragEnd:ge,onDragOver:ye,onDragLeave:we,onDrop:me,onDashDragOver:De,onDashDragLeave:Ie,onDashDrop:Te,startItemMove:Le,startItemResize:Pe,today:M}},template:`
<div>
  <!-- ===== \u25A0. \uD398\uC774\uC9C0 \uD0C0\uC774\uD2C0 ================================================= -->
    ...
    <div class="card" style="width:340px;flex-shrink:0;display:flex;flex-direction:column;padding:0;overflow:hidden;">
      <div style="padding:7px 12px;border-bottom:1px solid #f0f0f0;font-size:12px;font-weight:700;color:#555;background:#fafafa;flex-shrink:0;display:flex;align-items:center;justify-content:space-between;">
        <span class="list-title">
          \uD45C\uC2DC\uACBD\uB85C
          <span style="font-size:10px;color:#aaa;font-family:monospace;font-weight:400;margin-left:4px;">#ec_disp_ui</span>
        </span>
          ...
          <div :style="{
            ...
            <div :style="{
              ...
              <template v-for="(slot, idx) in cfCurrentSlots" :key="idx">
                ...
                <!-- ===== \u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0. \uBE44\uC5B4\uC788\uC74C ==================================== -->
                <div v-if="!slot ? (uiState.dragOverIdx!==idx) : false" style="height:100%;min-height:60px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;color:#d1d5db;padding:10px;">
                <span style="font-size:20px;">
                  +
                </span>
              ...
              <!-- ===== \u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0. \uB4DC\uB86D \uC624\uBC84 =================================== -->
              <div v-else-if="!slot ? (uiState.dragOverIdx===idx) : false" style="min-height:60px;display:flex;align-items:center;justify-content:center;color:#1d4ed8;font-size:12px;font-weight:700;padding:10px;">
              \u25BC \uC5EC\uAE30\uC5D0 \uCD94\uAC00
            </div>
            <!-- ===== \u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0.\u25A0. \uBC30\uCE58\uB428 ===================================== -->
...
<!-- ===== \u25A1.\u25A1. \uC624\uB978\uCABD (\uCE74\uB4DC) ============================================== -->
<!-- ===== \u25A1. 2\uB2E8 \uB808\uC774\uC544\uC6C3 ================================================= -->
`,components:{WidgetPreview:_WP_DispUiPreview}};
