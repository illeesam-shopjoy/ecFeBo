...
(function (global) {
  ...
  foApiSvc.pmEvent = {
    ...
    getTimedeal(uiNm, cmdNm) {
      return global.foApi.get('/fo/ec/pm/event/timedeal', hdr(uiNm, cmdNm));
    },
  };
  ...
  foApiSvc.pmPlan = {
    getPage(params, uiNm, cmdNm) {
      return global.foApi.get('/fo/ec/pm/plan/page', { params, ...hdr(uiNm, cmdNm) });
    },
    getById(_id, uiNm, cmdNm) {
      return chkId(_id, uiNm, cmdNm) || global.foApi.get(`/fo/ec/pm/plan/${_id}`, hdr(uiNm, cmdNm));
    },
    getTimedeal(uiNm, cmdNm) {
      return global.foApi.get('/fo/ec/pm/plan/timedeal', hdr(uiNm, cmdNm));
    },
  };
