...
(function (global) {
  ...
  boApiSvc.pmEventItem = {
    getList(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/ec/pm/event/items', { params, ...hdr(uiNm, cmdNm) }); },
  ...
  /* ── pm: 기획전 대상상품 (+ 타임딜) ───────────────────────────── */
  boApiSvc.pmPlanItem = {
    getList(params, uiNm, cmdNm)   { return global.boApi.get(   '/bo/ec/pm/plan/items', { params, ...hdr(uiNm, cmdNm) }); },
