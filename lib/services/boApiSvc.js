...
(function (global) {
  ...
  /* GET — pageNo/pageSize 는 URL 쿼리로 (coUtil.cofGetPaged) */
  const getP = (url, cfg) => coUtil.cofGetPaged(global.boApi, url, cfg);

  const boApiSvc = {};

  /* ── cm: 블로그 ─────────────────────────────────────────────── */
  boApiSvc.cmBlog = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/cm/blog/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/cm/blog/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.cmBlogFile = {
    getList(params, uiNm, cmdNm)     { return getP('/bo/ec/cm/blog-file', { params, ...hdr(uiNm, cmdNm) }); },
  ...
  boApiSvc.cmDashboard = {
    ...
    getDailyStats(targetDate, uiNm, cmdNm) {
      ...
      return getP('/bo/ec/cm/dashboard/daily-stats', { params, ...hdr(uiNm, cmdNm) });
    },
    getList(params, uiNm, cmdNm)      { return getP('/bo/ec/cm/dashboard/list', { params, ...hdr(uiNm, cmdNm) }); },
    getById(id, uiNm, cmdNm)          { return getP('/bo/ec/cm/dashboard/' + id, hdr(uiNm, cmdNm)); },
    ...
    getMenuTree(params, uiNm, cmdNm)  { return getP('/bo/ec/cm/dashboard/menu/tree', { params, ...hdr(uiNm, cmdNm) }); },
    ...
    getItemList(params, uiNm, cmdNm)  { return getP('/bo/ec/cm/dashboard/item/list', { params, ...hdr(uiNm, cmdNm) }); },
    /* 차트(1레벨) 서버사이드 페이징 — params: dashboardId|dashboardIds, useYn, itemNm, pageNo, pageSize */
    getItemPage(params, uiNm, cmdNm)  { return getP('/bo/ec/cm/dashboard/item/page', { params, ...hdr(uiNm, cmdNm) }); },
    /* 위와 동일 params + 응답에 treeRows 까지 포함(한 번의 왕복으로 목록+트리 동시 조회) */
    getItemPageWithTree(params, uiNm, cmdNm) { return getP('/bo/ec/cm/dashboard/item/page-with-tree', { params, ...hdr(uiNm, cmdNm) }); },
    ...
    getItemTree(params, uiNm, cmdNm)  { return getP('/bo/ec/cm/dashboard/item/tree', { params, ...hdr(uiNm, cmdNm) }); },
    getItemDataList(params, uiNm, cmdNm) { return getP('/bo/ec/cm/dashboard/item-data/list', { params, ...hdr(uiNm, cmdNm) }); },
    ...
    getDataGrid(params, uiNm, cmdNm)      { return getP('/bo/ec/cm/dashboard/data-grid', { params, ...hdr(uiNm, cmdNm) }); },
    ...
    simulateDataGrid(params, uiNm, cmdNm) { return getP('/bo/ec/cm/dashboard/data-grid/simulate', { params, ...hdr(uiNm, cmdNm) }); },
  };

  /* ── cm: 채팅 ───────────────────────────────────────────────── */
  boApiSvc.cmChatt = {
    getPage(params, uiNm, cmdNm, opt)     { return getP(   '/bo/ec/cm/chatt/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)        { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/cm/chatt/${_id}`, hdr(uiNm, cmdNm)); },
    getMessages(_id, params, uiNm, cmdNm) { return chkId(_id, uiNm, cmdNm) || getP(`/bo/ec/cm/chatt/${_id}/messages`, { params, ...hdr(uiNm, cmdNm) }); },
  ...
  /* ── cm: FAQ ────────────────────────────────────────────────── */
  boApiSvc.cmFaq = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/ec/cm/faq/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/cm/faq/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/cm/faq/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── cm: 공지사항 ───────────────────────────────────────────── */
  boApiSvc.cmNotice = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/cm/notice/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/cm/notice/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.cmPopupPick = {
    getConfig(popupCode, params, uiNm, cmdNm) { return getP(`/bo/cm/cmPopupPick/${popupCode}/config`, { params, ...hdr(uiNm, cmdNm) }); },
    getPage(popupCode, params, uiNm, cmdNm)   { return getP(`/bo/cm/cmPopupPick/${popupCode}/page`,   { params, ...hdr(uiNm, cmdNm) }); },
    getTree(popupCode, params, uiNm, cmdNm)   { return getP(`/bo/cm/cmPopupPick/${popupCode}/tree`,   { params, ...hdr(uiNm, cmdNm) }); },
    /* 팝업 정의 관리 */
    getPopupList(params, uiNm, cmdNm)   { return getP('/bo/cm/cmPopupPick/popup/list', { params, ...hdr(uiNm, cmdNm) }); },
    getPopupPage(params, uiNm, cmdNm)   { return getP('/bo/cm/cmPopupPick/popup/page', { params, ...hdr(uiNm, cmdNm) }); },
    getPopupItems(popupId, uiNm, cmdNm) { return getP(`/bo/cm/cmPopupPick/popup/${popupId}/items`, hdr(uiNm, cmdNm)); },
  ...
  /* ── dp: 전시영역 ───────────────────────────────────────────── */
  boApiSvc.dpArea = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/ec/dp/area/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)     { return getP(   '/bo/ec/dp/area/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getBasePage(params, uiNm, cmdNm) { return getP(   '/bo/ec/dp/area/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)        { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/dp/area/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── dp: 전시패널 ───────────────────────────────────────────── */
  boApiSvc.dpPanel = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/ec/dp/panel/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)     { return getP(   '/bo/ec/dp/panel/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getBasePage(params, uiNm, cmdNm) { return getP(   '/bo/ec/dp/panel/page', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)        { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/dp/panel/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── dp: 전시위젯 ───────────────────────────────────────────── */
  boApiSvc.dpWidget = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/ec/dp/widget/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/dp/widget/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/dp/widget/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── dp: 전시UI ─────────────────────────────────────────────── */
  boApiSvc.dpUi = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/ec/dp/ui/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/dp/ui/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/dp/ui/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.dpWidgetLib = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/ec/dp/widget-lib/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/dp/widget-lib/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/dp/widget-lib/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── mb: 고객종합정보 ───────────────────────────────────────── */
  boApiSvc.mbCustInfo = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/ec/mb/cust-info/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  };

  /* ── mb: 회원등급 ───────────────────────────────────────────── */
  boApiSvc.mbMemGrade = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/mb/member-grade/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  /* ── mb: 회원그룹 ───────────────────────────────────────────── */
  boApiSvc.mbMemGroup = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/mb/member-group/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  /* ── mb: 회원 ───────────────────────────────────────────────── */
  boApiSvc.mbMember = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/mb/member/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/ec/mb/member', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/mb/member/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.mbMemberLoginLog = {
    getPage(params, uiNm, cmdNm, opt) { return getP('/bo/ec/mb/member-login-log/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(`/bo/ec/mb/member-login-log/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── mb: 회원 토큰이력 ──────────────────────────────────────── */
  boApiSvc.mbMemberTokenLog = {
    getPage(params, uiNm, cmdNm, opt) { return getP('/bo/ec/mb/member-token-log/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(`/bo/ec/mb/member-token-log/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── od: 장바구니 ──────────────────────────────────────────── */
  boApiSvc.odCart = {
    getPage(params, uiNm, cmdNm, opt)  { return getP(   '/bo/ec/od/cart/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)     { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/od/cart/${_id}`, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || global.boApi.delete(`/bo/ec/od/cart/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── od: 클레임 ─────────────────────────────────────────────── */
  boApiSvc.odClaim = {
    getPage(params, uiNm, cmdNm, opt)       { return getP(   '/bo/ec/od/claim/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)          { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/od/claim/${_id}`, hdr(uiNm, cmdNm)); },
    ...
    /* 상태이력 조회 */
    getStatusHist(claimId, uiNm, cmdNm) { return getP(`/bo/ec/od/claim/${claimId}/status-hist`, hdr(uiNm, cmdNm)); },
  };

  /* ── od: 배송 ───────────────────────────────────────────────── */
  boApiSvc.odDliv = {
    getPage(params, uiNm, cmdNm, opt)       { return getP(   '/bo/ec/od/dliv/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)          { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/od/dliv/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── od: 주문 ───────────────────────────────────────────────── */
  boApiSvc.odOrder = {
    getPage(params, uiNm, cmdNm, opt)        { return getP(   '/bo/ec/od/order/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)           { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/od/order/${_id}`, hdr(uiNm, cmdNm)); },
    getKanban(_id, uiNm, cmdNm)         { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/od/order/${_id}/kanban`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.odOrderItem = {
    getPage(params, uiNm, cmdNm, opt) { return getP('/bo/ec/od/order-item/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getList(params, uiNm, cmdNm)      { return getP('/bo/ec/od/order-item',      { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)         { return chkId(_id, uiNm, cmdNm) || getP(`/bo/ec/od/order-item/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── pd: 묶음상품 ───────────────────────────────────────────── */
  boApiSvc.pdBundle = {
    getPage(params, uiNm, cmdNm, opt)        { return getP(   '/bo/ec/pd/bundle/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getItems(_id, uiNm, cmdNm)          { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pd/prod-bundle/${_id}/items`, hdr(uiNm, cmdNm)); },
  ...
  /* ── pd: 카테고리 ───────────────────────────────────────────── */
  boApiSvc.pdCategory = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/pd/category/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/ec/pd/category', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pd/category/${_id}`, hdr(uiNm, cmdNm)); },
    ...
    getProds(params, uiNm, cmdNm)  { return getP(   '/bo/ec/pd/category-prod/page', { params, ...hdr(uiNm, cmdNm) }); },
    updateProds(body, uiNm, cmdNm) { return global.boApi.put(   '/bo/ec/pd/category-prod', body, hdr(uiNm, cmdNm)); },
  };

  /* ── pd: 배송템플릿 ─────────────────────────────────────────── */
  boApiSvc.pdDlivTmplt = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/ec/pd/dliv-tmplt/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  /* ── pd: 상품 ───────────────────────────────────────────────── */
  boApiSvc.pdProd = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/pd/prod/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pd/prod/${_id}`, hdr(uiNm, cmdNm)); },
    getImages(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pd/prod/${_id}/images`,   hdr(uiNm, cmdNm)); },
    getOpts(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pd/prod/${_id}/opts`,     hdr(uiNm, cmdNm)); },
    getSkus(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pd/prod/${_id}/skus`,     hdr(uiNm, cmdNm)); },
    getContents(_id, uiNm, cmdNm)  { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pd/prod/${_id}/contents`, hdr(uiNm, cmdNm)); },
    ...
    getRels(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pd/prod/${_id}/rels`,     hdr(uiNm, cmdNm)); },
    getPlans(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pd/prod/${_id}/plans`,    hdr(uiNm, cmdNm)); },
  ...
  /* ── pd: Q&A ────────────────────────────────────────────────── */
  boApiSvc.pdQna = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/pd/qna/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pd/qna/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.pdRestockNoti = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/ec/pd/restock-noti/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    send(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pd/restock-noti/send', body, hdr(uiNm, cmdNm)); },
  };

  /* ── pd: 리뷰 ───────────────────────────────────────────────── */
  boApiSvc.pdReview = {
    getPage(params, uiNm, cmdNm, opt)         { return getP('/bo/ec/pd/review/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  /* ── pd: 세트상품 ───────────────────────────────────────────── */
  boApiSvc.pdSet = {
    getPage(params, uiNm, cmdNm, opt)         { return getP(   '/bo/ec/pd/prod-set/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getItems(_id, uiNm, cmdNm)          { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pd/prod-set/${_id}/items`, hdr(uiNm, cmdNm)); },
  ...
  /* ── pd: 태그 ───────────────────────────────────────────────── */
  boApiSvc.pdTag = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/pd/tag/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  /* ── pm: 캐시 ───────────────────────────────────────────────── */
  boApiSvc.pmCache = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/pm/cache/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pm/cache/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── pm: 쿠폰 ───────────────────────────────────────────────── */
  boApiSvc.pmCoupon = {
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/ec/pm/coupon', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/pm/coupon/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pm/coupon/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.pmCouponItem = {
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/ec/pm/coupon/items', { params, ...hdr(uiNm, cmdNm) }); },
  ...
  boApiSvc.pmCouponUsage = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/ec/pm/coupon-usage/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  };

  /* ── pm: 할인 ───────────────────────────────────────────────── */
  boApiSvc.pmDiscnt = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/pm/discnt/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pm/discnt/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.pmDiscntItem = {
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/ec/pm/discnt/items', { params, ...hdr(uiNm, cmdNm) }); },
  ...
  boApiSvc.pmDiscntUsage = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/ec/pm/discnt-usage/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  };

  /* ── pm: 이벤트 ─────────────────────────────────────────────── */
  boApiSvc.pmEvent = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/pm/event/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pm/event/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── pm: 이벤트 대상상품 (+ 타임딜) ───────────────────────────── */
  boApiSvc.pmEventItem = {
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/ec/pm/event/items', { params, ...hdr(uiNm, cmdNm) }); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pm/event/items', body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return chkId(_id, uiNm, cmdNm) || global.boApi.delete(`/bo/ec/pm/event/items/${_id}`, hdr(uiNm, cmdNm)); },
    createTimedeal(eventId, eventItemId, body, uiNm, cmdNm) { return global.boApi.post(  `/bo/ec/pm/event/${eventId}/item/${eventItemId}/timedeal`, body, hdr(uiNm, cmdNm)); },
    cancelTimedeal(eventItemId, uiNm, cmdNm)                { return chkId(eventItemId, uiNm, cmdNm) || global.boApi.delete(`/bo/ec/pm/event/item/${eventItemId}/timedeal`, hdr(uiNm, cmdNm)); },
  };

  /* ── pm: 사은품 ─────────────────────────────────────────────── */
  boApiSvc.pmGift = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/pm/gift/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pm/gift/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── pm: 사은품 조건 (상품연결) ──────────────────────────────── */
  boApiSvc.pmGiftCond = {
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/ec/pm/gift/gift-cond', { params, ...hdr(uiNm, cmdNm) }); },
  ...
  /* ── pm: 기획전 ─────────────────────────────────────────────── */
  boApiSvc.pmPlan = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/pm/plan/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pm/plan/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── pm: 기획전 대상상품 (+ 타임딜) ───────────────────────────── */
  boApiSvc.pmPlanItem = {
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/ec/pm/plan/items', { params, ...hdr(uiNm, cmdNm) }); },
    create(body, uiNm, cmdNm)      { return global.boApi.post(  '/bo/ec/pm/plan/items', body, hdr(uiNm, cmdNm)); },
    remove(_id, uiNm, cmdNm)       { return chkId(_id, uiNm, cmdNm) || global.boApi.delete(`/bo/ec/pm/plan/items/${_id}`, hdr(uiNm, cmdNm)); },
    createTimedeal(planId, planItemId, body, uiNm, cmdNm) { return global.boApi.post(  `/bo/ec/pm/plan/${planId}/item/${planItemId}/timedeal`, body, hdr(uiNm, cmdNm)); },
    cancelTimedeal(planItemId, uiNm, cmdNm)               { return chkId(planItemId, uiNm, cmdNm) || global.boApi.delete(`/bo/ec/pm/plan/item/${planItemId}/timedeal`, hdr(uiNm, cmdNm)); },
  };

  /* ── pm: 적립금 ─────────────────────────────────────────────── */
  boApiSvc.pmSave = {
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/ec/pm/save', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/pm/save/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pm/save/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── pm: 적립금 대상상품 ───────────────────────────────────── */
  boApiSvc.pmSaveItem = {
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/ec/pm/save/items', { params, ...hdr(uiNm, cmdNm) }); },
  ...
  boApiSvc.pmSaveUsage = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/ec/pm/save-usage/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  };

  /* ── pm: 바우처 ─────────────────────────────────────────────── */
  boApiSvc.pmVoucher = {
    getPage(params, uiNm, cmdNm, opt)    { return getP(   '/bo/ec/pm/voucher/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)       { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/ec/pm/voucher/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── pm: 상품쿠폰(선물 교환권) ─────────────────────────────── */
  boApiSvc.pmProdCoupon = {
    getList(params, uiNm, cmdNm)         { return global.boApi.get('/bo/ec/pm/prod-coupon', { params, ...hdr(uiNm, cmdNm) }); },
    cancel(_id, uiNm, cmdNm)             { return chkId(_id, uiNm, cmdNm) || global.boApi.post(`/bo/ec/pm/prod-coupon/${_id}/cancel`, {}, hdr(uiNm, cmdNm)); },
    extend(_id, days, uiNm, cmdNm)       { return chkId(_id, uiNm, cmdNm) || global.boApi.post(`/bo/ec/pm/prod-coupon/${_id}/extend?days=${days}`, {}, hdr(uiNm, cmdNm)); },
  };

  /* ── st: 배송수수료정책 ─────────────────────────────────────── */
  boApiSvc.stDlivFeePolicy = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/ec/st/dliv-fee-policy/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  boApiSvc.stSettleConfig = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/st/config/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  /* ── st: 정산마스터 ─────────────────────────────────────────── */
  boApiSvc.stSettle = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/ec/st/settle/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(`/bo/ec/st/settle/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── st: 정산원장 ───────────────────────────────────────────── */
  boApiSvc.stSettleRaw = {
    getPage(params, uiNm, cmdNm, opt)        { return getP(   '/bo/ec/st/raw/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)           { return chkId(_id, uiNm, cmdNm) || getP(`/bo/ec/st/raw/${_id}`, hdr(uiNm, cmdNm)); },
    /* orderId 기준 정산원장 목록 조회 (칸반 등 주문 기반 화면용) */
    getByOrderId(orderId, uiNm, cmdNm)  { return getP(   '/bo/ec/st/raw/page', { params: { orderId, pageSize: 100 }, ...hdr(uiNm, cmdNm) }); },
    collect(body, uiNm, cmdNm)          { return global.boApi.post(  '/bo/ec/st/raw/collect', body, hdr(uiNm, cmdNm)); },
  };

  /* ── st: 정산조정 ───────────────────────────────────────────── */
  boApiSvc.stSettleAdj = {
    getPage(params, uiNm, cmdNm, opt)    { return getP(   '/bo/ec/st/adj/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  boApiSvc.stSettleEtcAdj = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/st/etc-adj/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  boApiSvc.stSettlePay = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/ec/st/pay/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  boApiSvc.stSettleClose = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/ec/st/close/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  /* ── st: 정산대사 ───────────────────────────────────────────── */
  boApiSvc.stRecon = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/ec/st/recon/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  };

  /* ── st: ERP 정산 ───────────────────────────────────────────── */
  boApiSvc.stErp = {
    getGenPage(params, uiNm, cmdNm)   { return getP(   '/bo/ec/st/erp/gen/page', { params, ...hdr(uiNm, cmdNm) }); },
    getReconPage(params, uiNm, cmdNm) { return getP(   '/bo/ec/st/erp/recon/page', { params, ...hdr(uiNm, cmdNm) }); },
  ...
  /* ── sy: 알람 ───────────────────────────────────────────────── */
  boApiSvc.syAlarm = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/sy/alarm/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/alarm/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/alarm/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── sy: 첨부파일 ───────────────────────────────────────────── */
  boApiSvc.syAttach = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/sy/attach/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)         { return chkId(_id, uiNm, cmdNm) || getP(`/bo/sy/attach/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 배치 ───────────────────────────────────────────────── */
  boApiSvc.syBatch = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/sy/batch/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/batch/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return getP(   `/bo/sy/batch/${_id}`, hdr(uiNm, cmdNm)); },
    ...
    /* 수동 실행 — 배치를 지금 한 번 실행하고 실행 상태를 받는다(스케줄 등록 여부와 무관) */
    run(_id, uiNm, cmdNm)          { return chkId(_id, uiNm, cmdNm) || global.boApi.post(`/bo/sy/batch/${_id}/run`, {}, { ...hdr(uiNm, cmdNm), timeout: 600000 }); },
    saveList(cmd, rows, uiNm, cmdNm)    { return global.boApi.post('/bo/sy/batch/save-list/' + cmd, rows, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 배치이력 ───────────────────────────────────────────── */
  boApiSvc.syBatchLog = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/sy/batch-log/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(`/bo/sy/batch-log/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 게시판 ─────────────────────────────────────────────── */
  boApiSvc.syBbs = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/bbs/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/bbs/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── sy: 게시판모드(BBM) ────────────────────────────────────── */
  boApiSvc.syBbm = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/sy/bbm/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/bbm/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/bbm/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── sy: 브랜드 ─────────────────────────────────────────────── */
  boApiSvc.syBrand = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/sy/brand/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/sy/brand/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  /* ── sy: 공통코드그룹 ──────────────────────────────────────── */
  boApiSvc.syCodeGrp = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/sy/code-grp/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getAll(params, uiNm, cmdNm) { return getP(   '/bo/sy/code-grp', { params, ...hdr(uiNm, cmdNm) }); },
  ...
  /* ── sy: 공통코드 ───────────────────────────────────────────── */
  boApiSvc.syCode = {
    getAll(params, uiNm, cmdNm)    { return getP(   '/bo/sy/code', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/code/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/code/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── sy: 문의(Contact) ──────────────────────────────────────── */
  boApiSvc.syContact = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/contact/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/contact/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.syExceldown = {
    ...
    getStatus(domain, params, uiNm, cmdNm) { return getP(`/bo/exceldown/status/${domain}`, { params, ...hdr(uiNm, cmdNm) }); },
    ...
    getPage(params, uiNm, cmdNm, opt)  { return getP('/bo/exceldown/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)          { return chkId(_id, uiNm, cmdNm) || getP(`/bo/exceldown/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.syDept = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/sy/dept/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getList(params, uiNm, cmdNm) { return getP(   '/bo/sy/dept', { params, ...hdr(uiNm, cmdNm) }); },
    getTree(uiNm, cmdNm)         { return getP(   '/bo/sy/dept/tree', hdr(uiNm, cmdNm)); },
  ...
  /* ── sy: i18n 다국어 ────────────────────────────────────────── */
  boApiSvc.syI18n = {
    getPage(params, uiNm, cmdNm, opt)       { return getP(   '/bo/sy/i18n/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  boApiSvc.syNoti = {
    getMyList(params, uiNm, cmdNm)   { return getP('/bo/sy/noti/my', { params, ...hdr(uiNm, cmdNm) }); },
    getMyPage(params, uiNm, cmdNm, opt) { return getP('/bo/sy/noti/my/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getMyUnreadCount(uiNm, cmdNm)    { return getP('/bo/sy/noti/my/unread-count', hdr(uiNm, cmdNm)); },
    getPage(params, uiNm, cmdNm, opt) { return getP('/bo/sy/noti/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)        { return chkId(_id, uiNm, cmdNm) || getP(`/bo/sy/noti/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── sy: 메뉴 ───────────────────────────────────────────────── */
  boApiSvc.syMenu = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/sy/menu/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/sy/menu/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getList(params, uiNm, cmdNm) { return getP(   '/bo/sy/menu', { params, ...hdr(uiNm, cmdNm) }); },
  ...
  /* ── sy: 표시경로 ───────────────────────────────────────────── */
  boApiSvc.syPath = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/path/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  /* ── sy: 시스템속성 ─────────────────────────────────────────── */
  boApiSvc.syProp = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/sy/prop/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/sy/prop', { params, ...hdr(uiNm, cmdNm) }); },
    /* opt: axios config 추가 옵션. 예) { isProgress: false } — 진행 오버레이 미표시(무한 스크롤 추가 조회) */
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/prop/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  ...
  /* ── sy: 역할 ───────────────────────────────────────────────── */
  boApiSvc.syRole = {
    getPage(params, uiNm, cmdNm, opt)      { return getP(   '/bo/sy/role/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getList(params, uiNm, cmdNm)      { return getP(   '/bo/sy/role', { params, ...hdr(uiNm, cmdNm) }); },
    getMenus(_id, uiNm, cmdNm)        { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/role/${_id}/menus`, hdr(uiNm, cmdNm)); },
    getUsers(_id, uiNm, cmdNm)        { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/role/${_id}/users`, hdr(uiNm, cmdNm)); },
  ...
  /* ── sy: 역할메뉴 ───────────────────────────────────────────── */
  boApiSvc.syRoleMenu = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/sy/role-menu/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
  };

  /* ── sy: 사이트 ─────────────────────────────────────────────── */
  boApiSvc.sySite = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/site/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/site/${_id}`, hdr(uiNm, cmdNm)); },
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP(   '/bo/sy/site/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
  ...
  /* ── sy: 템플릿 ─────────────────────────────────────────────── */
  boApiSvc.syTemplate = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/sy/template/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/template/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/template/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  /* ── sy: 사용자 (관리자 계정) ───────────────────────────────── */
  boApiSvc.syUser = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/user/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/sy/user', { params, ...hdr(uiNm, cmdNm) }); },
    getDeptTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/sy/user/dept-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/user/${_id}`, hdr(uiNm, cmdNm)); },
    getRoles(_id, uiNm, cmdNm)     { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/user/${_id}/roles`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.syUserLoginLog = {
    getPage(params, uiNm, cmdNm, opt) { return getP('/bo/sy/user-login-log/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(`/bo/sy/user-login-log/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 사용자 토큰이력 ────────────────────────────────────── */
  boApiSvc.syUserTokenLog = {
    getPage(params, uiNm, cmdNm, opt) { return getP('/bo/sy/user-token-log/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(`/bo/sy/user-token-log/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: API요청로그 ────────────────────────────────────────── */
  boApiSvc.syAccessLog = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/sy/access-log/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(`/bo/sy/access-log/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: API오류로그 ────────────────────────────────────────── */
  boApiSvc.syAccessErrorLog = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/sy/access-error-log/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(`/bo/sy/access-error-log/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 알림 발송이력 (syh_alarm_send_hist) ─────────────────── */
  boApiSvc.syAlarmSendHist = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/sy/alarm-send-hist/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(`/bo/sy/alarm-send-hist/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 메일 발송이력 (syh_send_email_log) ──────────────────── */
  boApiSvc.sySendEmailLog = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/sy/send-email-log/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(`/bo/sy/send-email-log/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 메시지 발송이력 (syh_send_msg_log, SMS·카카오) ──────── */
  boApiSvc.sySendMsgLog = {
    getPage(params, uiNm, cmdNm, opt) { return getP(   '/bo/sy/send-msg-log/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)    { return chkId(_id, uiNm, cmdNm) || getP(`/bo/sy/send-msg-log/${_id}`, hdr(uiNm, cmdNm)); },
  };

  /* ── sy: 업체(Vendor) ───────────────────────────────────────── */
  boApiSvc.syVendor = {
    getPathTreeNodeCounts(params, uiNm, cmdNm) { return getP('/bo/sy/vendor/path-counts', { params, ...hdr(uiNm, cmdNm) }); },
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/vendor/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getById(_id, uiNm, cmdNm)      { return chkId(_id, uiNm, cmdNm) || getP(   `/bo/sy/vendor/${_id}`, hdr(uiNm, cmdNm)); },
  ...
  boApiSvc.syVendorUser = {
    getPage(params, uiNm, cmdNm, opt)   { return getP(   '/bo/sy/vendor-user/page', { params, ...hdr(uiNm, cmdNm), ...(opt || {}) }); },
    getList(params, uiNm, cmdNm)   { return getP(   '/bo/sy/vendor-user', { params, ...hdr(uiNm, cmdNm) }); },
    getRoles(params, uiNm, cmdNm)  { return getP(   '/bo/sy/vendor-user-role', { params, ...hdr(uiNm, cmdNm) }); },
  ...
  boApiSvc.zdSimulLog = {
    getPage(params, uiNm, cmdNm) { return getP('/bo/zd/simul/log/page', { params, ...hdr(uiNm || '시뮬레이터', cmdNm || '로그조회') }); },
